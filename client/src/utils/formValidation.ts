...
export function validateLessonPlan(data: LessonPlanFormData): ValidationResult {
  ...
  if ((hasMindsOn === undefined || hasMindsOn === '') && 
      (hasAction === undefined || hasAction === '') && 
      (hasConsolidation === undefined || hasConsolidation === '')) {
  ...
  if (data.learningGoals !== null && data.learningGoals !== undefined && data.learningGoals.length > 1000) {
