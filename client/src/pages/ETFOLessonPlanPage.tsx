...
export function ETFOLessonPlanPage(): React.ReactElement {
          ...
          <div className="px-6 py-4 border-b">
            <div className="flex justify-between items-start">
              <div>
                ...
                {selectedLesson.titleFr && selectedLesson.titleFr !== '' && (
 ...
 downloadHTML(
          ...
          <div className="p-6 space-y-6">
            {selectedLesson.learningGoals && selectedLesson.learningGoals !== '' && (
              <div>
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              <Card>
                ...
                <CardContent>
                  {selectedLesson.mindsOn && selectedLesson.mindsOn !== '' ? (
                    <SafeHtmlRenderer
              ...
              <Card>
                ...
                <CardContent>
                  {selectedLesson.action && selectedLesson.action !== '' ? (
                    <SafeHtmlRenderer
                      className="prose max-w-none text-sm"
              ...
              <Card>
                ...
                <CardContent>
                  {selectedLesson.consolidation && selectedLesson.consolidation !== '' ? (
                    <SafeHtmlRenderer
                      className="prose max-w-none text-sm"
            ...
            {/* Assessment */}
            {(selectedLesson.assessmentType || (selectedLesson.assessmentNotes && selectedLesson.assessmentNotes !== '')) && (
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Assessment</h3>
                {selectedLesson.assessmentType && (
                  <Badge className="mb-2">{selectedLesson.assessmentType}</Badge>
                )}
                {selectedLesson.assessmentNotes && selectedLesson.assessmentNotes !== '' && (
            ...
            {/* Sub Notes */}
            {selectedLesson.isSubFriendly && selectedLesson.subNotes && selectedLesson.subNotes !== '' && (
