...
describe.skip('Activity Components Accessibility Tests', () => {
  ...
  describe('ActivitySuggestions Accessibility', () => {
    ...
    it('should have proper ARIA labels and roles', async () => {
      ...
      const activities = screen.getAllByText('📅 Add to Plan');
    ...
    it('should provide meaningful screen reader announcements', async () => {
      render(<ActivitySuggestions outcomeIds={['FR4.1', 'FR4.2']} />, { wrapper });
    ...
    it('should handle empty state accessibly', async () => {
      ...
      const { container } = render(<ActivitySuggestions outcomeIds={['NONEXISTENT']} />, {
        wrapper,
      });
  ...
  describe('ActivityLibrary Accessibility', () => {
    ...
    it('should handle grid/list view accessibility', async () => {
      const { rerender } = render(<ActivityLibrary defaultView="grid" />, { wrapper });
  ...
  describe('ActivityEditor Accessibility', () => {
    const mockThemes = [
      {
        id: 1,
