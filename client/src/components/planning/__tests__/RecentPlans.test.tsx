...
describe('RecentPlans', () => {
  const mockRecentPlans: RecentPlan[] = [
    ...
    },
    {
      ...
      subject: 'Mathematics',
      grade: 5,
      lastAccessed: '2024-09-19T15:30:00Z',
      progress: 40,
      status: 'in-progress',
    ...
    },
    {
      ...
      subject: 'Mathematics',
      grade: 5,
      lastAccessed: '2024-09-18T08:00:00Z',
      progress: 100,
      status: 'completed',
    ...
    },
    {
      ...
      lastAccessed: '2024-09-17T16:00:00Z',
      status: 'draft',
    },
  ];
  ...
  describe('Filtering and Sorting', () => {
    ...
    it('should limit display to most recent plans', () => {
      const manyPlans: RecentPlan[] = Array.from({ length: 20 }, (_, i) => ({
        ...
        type: 'lesson',
        title: `Lesson ${i}`,
        lastAccessed: `2024-08-${20 - i < 10 ? '0' + (20 - i) : 20 - i}T10:00:00Z`,
        status: 'draft',
      }));
