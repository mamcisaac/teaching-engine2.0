...
export const CalendarEventDetails = lazy(() => import('./CalendarEventDetails'));
export const CalendarFilters = lazy(() => import('./CalendarFilters'));
...
export const createMomentLocalizer = () => {
  return import('react-big-calendar').then(async (bigCalendarModule) => {
