    ...
    try {
      ...
      setSuggestions(prev => [
        ...prev.filter(s => s.type !== type),
        {
          ...
          rationale: (result.rationale !== null && result.rationale !== undefined && result.rationale !== '') ? result.rationale : '',
        }
      ]);
                    ...
                    <Card key={`${suggestion.type}-${_index}`}>
                      <CardHeader>
                        <CardTitle className="text-base capitalize flex items-center gap-2">
                          ...
                          {(suggestion.timeEstimate !== null && suggestion.timeEstimate !== undefined && suggestion.timeEstimate !== 0) && suggestion.timeEstimate > 0 && !isNaN(suggestion.timeEstimate) && (
                            <Badge className="ml-auto" variant="outline">
