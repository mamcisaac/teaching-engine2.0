...
export function AILoadingIndicator({
 ...
 clearTimeout(timeout); 
  ...
  const currentStepIndex = (currentStepId != null && currentStepId !== '') ? steps.findIndex((step) => step.id === currentStepId) : -1;
      ...
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md mx-4">
        ...
        {state === 'error' && (
          <div 
            ...
            className="sr-only"
          >
            AI generation failed{(error != null && error !== '') ? `: ${error}` : ''}
          </div>
        )}
        ...
        {/* Success Message */}
        {state === 'success' && (successMessage != null && successMessage !== '') && (
