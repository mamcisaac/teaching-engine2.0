...
import { __awaiter } from './chunk-TEAACC2D.js';
...
function fromDataTransferItem(item, entry) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const fwp = toFileWithPath(
      file,
      (_a = entry === null || entry === void 0 ? void 0 : entry.fullPath) !== null && _a !== void 0
        ? _a
        : void 0,
    );
    return fwp;
...
var accepts =
  typeof import_attr_accept.default === 'function'
    ? import_attr_accept.default
    : import_attr_accept.default.default;
    ...
    var acceptForPicker = Object.entries(accept)
      .filter(function (_ref2) {
        ...
        if (!Array.isArray(ext) || !ext.every(isExt)) {
          console.warn(
            'Skipped "'.concat(mimeType, '" because an invalid file extension was provided.'),
          );
          ok = false;
        }
        return ok;
...
Dropzone.propTypes = {
   ...
   */
  accept: import_prop_types.default.objectOf(
...
function useDropzone() {
  ...
  var acceptAttr = (0, import_react.useMemo)(
    function () {
      return acceptPropAsAcceptAttr(accept);
    },
    [accept],
  );
  var pickerTypes = (0, import_react.useMemo)(
    function () {
      return pickerOptionsFromAccept(accept);
    },
    [accept],
  );
  var onFileDialogOpenCb = (0, import_react.useMemo)(
    function () {
      return typeof onFileDialogOpen === 'function' ? onFileDialogOpen : noop;
    },
    [onFileDialogOpen],
  );
  var onFileDialogCancelCb = (0, import_react.useMemo)(
    function () {
  ...
  var _useReducer = (0, import_react.useReducer)(reducer, initialState),
    _useReducer2 = _slicedToArray2(_useReducer, 2),
    state = _useReducer2[0],
    dispatch = _useReducer2[1];
  var isFocused = state.isFocused,
    isFileDialogActive = state.isFileDialogActive;
  var fsAccessApiWorksRef = (0, import_react.useRef)(
  ...
  var onErrCb = (0, import_react.useCallback)(
    function (e) {
      if (onError) {
        onError(e);
      } else {
  ...
  var onDragEnterCb = (0, import_react.useCallback)(
    function (event) {
      event.preventDefault();
      event.persist();
      stopPropagation(event);
      dragTargetsRef.current = [].concat(_toConsumableArray2(dragTargetsRef.current), [
        event.target,
      ]);
  ...
  var onDragOverCb = (0, import_react.useCallback)(
    function (event) {
      event.preventDefault();
      event.persist();
      stopPropagation(event);
  ...
  var onDragLeaveCb = (0, import_react.useCallback)(
    function (event) {
      event.preventDefault();
      event.persist();
      stopPropagation(event);
  ...
  var setFiles = (0, import_react.useCallback)(
  ...
  var onDropCb = (0, import_react.useCallback)(
    function (event) {
      event.preventDefault();
      event.persist();
      stopPropagation(event);
  ...
  var openFileDialog = (0, import_react.useCallback)(
    function () {
  ...
  var onKeyDownCb = (0, import_react.useCallback)(
    function (event) {
  ...
  var onClickCb = (0, import_react.useCallback)(
    function () {
      if (noClick) {
        return;
      }
  ...
  var getRootProps = (0, import_react.useMemo)(
    function () {
      return function () {
  ...
  var getInputProps = (0, import_react.useMemo)(
    function () {
      return function () {
