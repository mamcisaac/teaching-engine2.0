...
var AlertDialogTrigger = React.forwardRef((props, forwardedRef) => {
  ...
  const dialogScope = useDialogScope(__scopeAlertDialog);
  return (0, import_jsx_runtime.jsx)(Trigger, {
    ...dialogScope,
    ...triggerProps,
    ref: forwardedRef,
  });
...
var AlertDialogOverlay = React.forwardRef((props, forwardedRef) => {
  ...
  const dialogScope = useDialogScope(__scopeAlertDialog);
  return (0, import_jsx_runtime.jsx)(Overlay, {
    ...dialogScope,
    ...overlayProps,
    ref: forwardedRef,
  });
...
var AlertDialogContent = React.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime.jsx)(WarningProvider, {
    contentName: CONTENT_NAME,
    titleName: TITLE_NAME,
    docsSlug: 'alert-dialog',
    children: (0, import_jsx_runtime.jsx)(AlertDialogContentProvider, {
      scope: __scopeAlertDialog,
      cancelRef,
      children: (0, import_jsx_runtime.jsxs)(Content, {
        role: 'alertdialog',
        ...dialogScope,
        ...contentProps,
        ref: composedRefs,
