...
var ScrollAreaScrollbar = React2.forwardRef((props, forwardedRef) => {
  ...
  return context.type === 'hover'
    ? (0, import_jsx_runtime.jsx)(ScrollAreaScrollbarHover, {
        ...scrollbarProps,
        ref: forwardedRef,
        forceMount,
      })
    : context.type === 'scroll'
      ? (0, import_jsx_runtime.jsx)(ScrollAreaScrollbarScroll, {
          ...scrollbarProps,
          ref: forwardedRef,
          forceMount,
        })
      : context.type === 'auto'
        ? (0, import_jsx_runtime.jsx)(ScrollAreaScrollbarAuto, {
            ...scrollbarProps,
            ref: forwardedRef,
            forceMount,
          })
        : context.type === 'always'
          ? (0, import_jsx_runtime.jsx)(ScrollAreaScrollbarVisible, {
              ...scrollbarProps,
              ref: forwardedRef,
            })
          : null;
...
var ScrollAreaScrollbarVisible = React2.forwardRef((props, forwardedRef) => {
  ...
  if (orientation === 'horizontal') {
    return (0, import_jsx_runtime.jsx)(ScrollAreaScrollbarX, {
      ...commonProps,
      ref: forwardedRef,
  ...
  if (orientation === 'vertical') {
    return (0, import_jsx_runtime.jsx)(ScrollAreaScrollbarY, {
      ...commonProps,
      ref: forwardedRef,
      onThumbPositionChange: () => {
        if (context.viewport && thumbRef.current) {
...
var ScrollAreaScrollbarX = React2.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime.jsx)(ScrollAreaScrollbarImpl, {
...
var ScrollAreaScrollbarImpl = React2.forwardRef((props, forwardedRef) => {
  ...
  useResizeObserver(context.content, handleResize);
  return (0, import_jsx_runtime.jsx)(ScrollbarProvider, {
    scope: __scopeScrollArea,
    scrollbar,
    hasThumb,
...
var ScrollAreaCorner = React2.forwardRef((props, forwardedRef) => {
  ...
  return hasCorner
    ? (0, import_jsx_runtime.jsx)(ScrollAreaCornerImpl, { ...props, ref: forwardedRef })
    : null;
});
