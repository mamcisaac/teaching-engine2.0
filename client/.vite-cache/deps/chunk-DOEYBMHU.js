...
import { useLayoutEffect2 } from './chunk-VAHCZYSV.js';
      ...
      if (!overflows.every((side2) => side2 <= 0)) {
        ...
        if (nextPlacement) {
          ...
          if (
            ...
            overflowsData.every(
              (d) => d.overflows[0] > 0 && getSideAxis(d.placement) === initialSideAxis,
            )
          ) {
            return {
              data: {
...
var PopperAnchor = React3.forwardRef((props, forwardedRef) => {
  ...
  return virtualRef
    ? null
    : (0, import_jsx_runtime2.jsx)(Primitive.div, { ...anchorProps, ref: composedRefs });
});
PopperAnchor.displayName = ANCHOR_NAME;
var CONTENT_NAME = 'PopperContent';
var [PopperContentProvider, useContentContext] = createPopperContext(CONTENT_NAME);
var PopperContent = React3.forwardRef((props, forwardedRef) => {
  const {
    __scopePopper,
    side = 'bottom',
    sideOffset = 0,
...
export { createPopperScope, Root2, Anchor, Content, Arrow2 as Arrow };
//# sourceMappingURL=chunk-DOEYBMHU.js.map
