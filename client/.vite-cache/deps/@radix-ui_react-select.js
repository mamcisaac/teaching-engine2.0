...
var Select = (props) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Root2, {
    ...popperScope,
    children: (0, import_jsx_runtime2.jsxs)(SelectProvider, {
      required,
      scope: __scopeSelect,
      trigger,
      ...
      disabled,
      children: [
        (0, import_jsx_runtime2.jsx)(Collection.Provider, {
          scope: __scopeSelect,
          children: (0, import_jsx_runtime2.jsx)(SelectNativeOptionsProvider, {
...
var SelectTrigger = React2.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Anchor, {
    asChild: true,
    ...popperScope,
    children: (0, import_jsx_runtime2.jsx)(Primitive.button, {
      type: 'button',
      role: 'combobox',
...
var SelectValue = React2.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Primitive.span, {
    ...valueProps,
    ref: composedRefs,
    style: { pointerEvents: 'none' },
    children: shouldShowPlaceholder(context.value)
      ? (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: placeholder })
      : children,
  });
});
SelectValue.displayName = VALUE_NAME;
var ICON_NAME = 'SelectIcon';
var SelectIcon = React2.forwardRef((props, forwardedRef) => {
...
var SelectContent = React2.forwardRef((props, forwardedRef) => {
  ...
  if (!context.open) {
    ...
    return frag
      ? ReactDOM.createPortal(
          (0, import_jsx_runtime2.jsx)(SelectContentProvider, {
            scope: props.__scopeSelect,
            children: (0, import_jsx_runtime2.jsx)(Collection.Slot, {
              scope: props.__scopeSelect,
              children: (0, import_jsx_runtime2.jsx)('div', { children: props.children }),
            }),
          }),
          frag,
        )
...
var SelectContentImpl = React2.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
  ...
  const [selectedItemText, setSelectedItemText] = React2.useState(null);
  const getItems = useCollection(__scopeSelect);
  ...
  const popperContentProps =
    SelectPosition === SelectPopperPosition
      ...
      : {};
  return (0, import_jsx_runtime2.jsx)(SelectContentProvider, {
    scope: __scopeSelect,
    content,
    viewport,
    ...
    isPositioned,
    searchRef,
    children: (0, import_jsx_runtime2.jsx)(Combination_default, {
      as: Slot,
      allowPinchZoom: true,
      children: (0, import_jsx_runtime2.jsx)(FocusScope, {
        asChild: true,
        ...
        children: (0, import_jsx_runtime2.jsx)(DismissableLayer, {
          ...
          children: (0, import_jsx_runtime2.jsx)(SelectPosition, {
            role: 'listbox',
...
var SelectItemAlignedPosition = React2.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime2.jsx)(SelectViewportProvider, {
    scope: __scopeSelect,
    contentWrapper,
...
var SelectViewport = React2.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, {
    children: [
      ...
      (0, import_jsx_runtime2.jsx)(Collection.Slot, {
        scope: __scopeSelect,
        children: (0, import_jsx_runtime2.jsx)(Primitive.div, {
...
var SelectGroup = React2.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, ...groupProps } = props;
  const groupId = useId();
  return (0, import_jsx_runtime2.jsx)(SelectGroupContextProvider, {
    scope: __scopeSelect,
    id: groupId,
    children: (0, import_jsx_runtime2.jsx)(Primitive.div, {
      role: 'group',
...
var SelectLabel = React2.forwardRef((props, forwardedRef) => {
...
var SelectItem = React2.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime2.jsx)(SelectItemContextProvider, {
    scope: __scopeSelect,
    value,
    disabled,
    textId,
    ...
    children: (0, import_jsx_runtime2.jsx)(Collection.ItemSlot, {
      scope: __scopeSelect,
      value,
      disabled,
      textValue,
...
var SelectItemText = React2.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, {
    children: [
      (0, import_jsx_runtime2.jsx)(Primitive.span, {
...
var SelectItemIndicator = React2.forwardRef((props, forwardedRef) => {
...
var SelectScrollUpButton = React2.forwardRef((props, forwardedRef) => {
  ...
  return canScrollUp
    ? (0, import_jsx_runtime2.jsx)(SelectScrollButtonImpl, {
        ...props,
        ref: composedRefs,
        onAutoScroll: () => {
...
var SelectSeparator = React2.forwardRef((props, forwardedRef) => {
...
var SelectArrow = React2.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, ...arrowProps } = props;
  const popperScope = usePopperScope(__scopeSelect);
  const context = useSelectContext(ARROW_NAME, __scopeSelect);
  const contentContext = useSelectContentContext(ARROW_NAME, __scopeSelect);
  return context.open && contentContext.position === 'popper'
    ? (0, import_jsx_runtime2.jsx)(Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef })
    : null;
});
SelectArrow.displayName = ARROW_NAME;
var BUBBLE_INPUT_NAME = 'SelectBubbleInput';
var SelectBubbleInput = React2.forwardRef(({ __scopeSelect, value, ...props }, forwardedRef) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Primitive.select, {
    ...props,
    style: { ...VISUALLY_HIDDEN_STYLES, ...props.style },
    ref: composedRefs,
    defaultValue: value,
