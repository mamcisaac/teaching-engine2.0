...
// ../node_modules/.pnpm/react-to-print@3.1.0_react@18.3.1/node_modules/react-to-print/lib/index.js
      ...
      return (function () {
        ...
        ((n.d = function (e2, t2) {
          for (var o2 in t2)
            n.o(t2, o2) &&
              !n.o(e2, o2) &&
              Object.defineProperty(e2, o2, { enumerable: true, get: t2[o2] });
        }),
          (n.o = function (e2, t2) {
              ...
              if ((e2.contentWindow.focus(), c2))
                ...
                if (e2.contentWindow.print) {
                  const h2 =
                      null !==
                        (u2 =
                          null === (t3 = e2.contentDocument) || void 0 === t3
                            ? void 0
                            : t3.title) && void 0 !== u2
                        ? u2
                        : '',
                    f2 = e2.ownerDocument.title;
                  (o2 &&
                    ((e2.ownerDocument.title = o2),
                    e2.contentDocument && (e2.contentDocument.title = o2)),
                    e2.contentWindow.print(),
                    o2 &&
                      ((e2.ownerDocument.title = f2),
                      e2.contentDocument && (e2.contentDocument.title = h2)));
                } else
                  i({
                    messages: [
                ...
                [
                  ...
                  return (
                    null !==
                      (o3 =
                        null !== (t4 = navigator.userAgent) && void 0 !== t4
                          ? t4
                          : navigator.vendor) && void 0 !== o3
                      ? o3
        ...
        function d(e2) {
          const t2 = [],
            o2 = document.createTreeWalker(e2, NodeFilter.SHOW_ELEMENT, null);
          let n2 = o2.nextNode();
        ...
        function h(e2, t2, o2, n2) {
          ...
          e2.onload = null;
          const x =
            null !== (r2 = e2.contentDocument) && void 0 !== r2
              ? r2
              : null === (s2 = e2.contentWindow) || void 0 === s2
                ? void 0
                : s2.document;
          if (x) {
            ...
            (k && u(f2, o3, !!P),
              E &&
                ((null === (l2 = e2.contentDocument) || void 0 === l2 ? void 0 : l2.fonts) &&
                (null === (d2 = e2.contentWindow) || void 0 === d2 ? void 0 : d2.FontFace)
                  ? E.forEach((o4) => {
                      const n4 = new FontFace(o4.family, o4.source, {
                        weight: o4.weight,
                        style: o4.style,
                      });
                      (e2.contentDocument.fonts.add(n4),
                        n4.loaded
                          .then(() => {
                            t2(n4);
                          })
            ...
            const n3 = null != T ? T : p,
              r3 = x.createElement('style');
            (S && (r3.setAttribute('nonce', S), x.head.setAttribute('nonce', S)),
              r3.appendChild(x.createTextNode(n3)),
              x.head.appendChild(r3),
              w && x.body.classList.add(...w.split(' ')));
            ...
            const c2 = 'select',
              y2 = f2.querySelectorAll(c2),
              C = x.querySelectorAll(c2);
                ...
                if ('style' === n5.tagName.toLowerCase()) {
                  ...
                  if (t3) {
                    ...
                    try {
                      ...
                      for (let o5 = 0; o5 < e5; ++o5)
                        'string' == typeof t3.cssRules[o5].cssText &&
                          (r4 += `${t3.cssRules[o5].cssText}\r
`);
                    } catch (e5) {
                      i({
                        messages: [
                          ...
                          n5,
                          `Original error: ${a(e5).message}`,
                        ],
                        level: 'warning',
                      });
                    }
                    (e4.setAttribute('id', `react-to-print-${o4}`),
                      S && e4.setAttribute('nonce', S),
                      e4.appendChild(x.createTextNode(r4)),
                      x.head.appendChild(e4));
                  }
                } else if (n5.getAttribute('href'))
                  if (n5.hasAttribute('disabled'))
                    (i({
                      messages: [
                    ...
                    for (let t3 = 0, o5 = n5.attributes.length; t3 < o5; ++t3) {
                      ...
                      o6 &&
                        e4.setAttribute(
                          o6.nodeName,
                          null !== (h2 = o6.nodeValue) && void 0 !== h2 ? h2 : '',
                        );
                    }
                    ((e4.onload = () => {
                      t2(e4);
              ...
              function w() {
                const l2 = {
                  ...
                  a2 = (function () {
                    ...
                    return (
                      (e3.width = `${document.documentElement.clientWidth}px`),
                      (e3.height = `${document.documentElement.clientHeight}px`),
                      (e3.style.position = 'absolute'),
                      (e3.style.top = `-${document.documentElement.clientHeight + 100}px`),
                      (e3.style.left = `-${document.documentElement.clientWidth + 100}px`),
                      (e3.id = 'printWindow'),
                      (e3.srcdoc = '<!DOCTYPE html>'),
                      e3
                    );
                  })(),
                  w2 = (function (e3, t3) {
                    const {
                        contentRef: o3,
                        fonts: n3,
                        ignoreGlobalStyles: r3,
                        suppressErrors: s3,
                      } = t3,
                      l3 = (function ({ contentRef: e4, optionalContent: t4, suppressErrors: o4 }) {
                        return !t4 ||
                          t4 instanceof Event ||
                          (e4 &&
                            i({
                    ...
                    if (!l3) return;
                    const a3 = l3.cloneNode(true),
                      c2 = document.querySelectorAll("link[rel~='stylesheet'], link[as='style']"),
                      d3 = a3.querySelectorAll('img'),
                      u3 = a3.querySelectorAll('video'),
                      p3 = n3 ? n3.length : 0;
                    return {
                      contentNode: l3,
                      clonedContentNode: a3,
                      clonedImgNodes: d3,
                      clonedVideoNodes: u3,
                      numResourcesToLoad: (r3 ? 0 : c2.length) + d3.length + u3.length + p3,
                      originalCanvasNodes: l3.querySelectorAll('canvas'),
                    };
                  })(s2, l2);
                if (!w2)
                  return void i({ messages: ['There is nothing to print'], suppressErrors: v });
                const E = (function (e3, t3, o3) {
                  const { suppressErrors: n3 } = e3,
                    r3 = [],
                    s3 = [];
                  return function (l3, a3) {
                    r3.includes(l3)
                      ? i({
                          level: 'debug',
                          messages: ['Tried to mark a resource that has already been handled', l3],
                          suppressErrors: n3,
                        })
                      : (a3
                          ? (i({
                            ...
                            s3.push(l3))
                          : r3.push(l3),
                        r3.length + s3.length === t3 && c(o3, e3));
                  };
