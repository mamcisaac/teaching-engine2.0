import { __assign, __rest, __spreadArray } from './chunk-TEAACC2D.js';
import { useCallbackRef } from './chunk-3YYFI7F7.js';
import { composeEventHandlers, useLayoutEffect2 } from './chunk-VAHCZYSV.js';
import { Primitive, dispatchDiscreteCustomEvent, useComposedRefs } from './chunk-I6QS7MJJ.js';
...
var Portal = React4.forwardRef((props, forwardedRef) => {
  ...
  return container
    ? import_react_dom.default.createPortal(
        (0, import_jsx_runtime3.jsx)(Primitive.div, { ...portalProps, ref: forwardedRef }),
        container,
      )
    : null;
});
...
var useIsomorphicLayoutEffect =
  typeof window !== 'undefined' ? React6.useLayoutEffect : React6.useEffect;
...
var RemoveScroll = React10.forwardRef(function (props, parentRef) {
  ...
  return React10.createElement(
    ...
    null,
    enabled &&
      React10.createElement(SideCar2, {
        sideCar: effectCar,
        removeScrollBar,
        shards,
        noRelative,
    ...
    forwardProps
      ? React10.cloneElement(
          React10.Children.only(children),
...
var RemoveScrollBar = function (_a) {
  ...
  useLockAttribute();
  var gap = React12.useMemo(
    function () {
      return getGapWidth(gapMode);
    },
    [gapMode],
  );
  return React12.createElement(Style, {
...
function RemoveScrollSideCar(props) {
  ...
  return React13.createElement(
    ...
    removeScrollBar
      ? React13.createElement(RemoveScrollBar, {
          noRelative: props.noRelative,
          gapMode: props.gapMode,
        })
      : null,
...
export { DismissableLayer, FocusScope, Portal, useFocusGuards, Combination_default, hideOthers };
//# sourceMappingURL=chunk-NWDX3MTF.js.map
