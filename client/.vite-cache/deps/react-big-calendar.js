import { require_prop_types } from './chunk-2SY4J5M5.js';
import { require_react_dom } from './chunk-UET6Q7XZ.js';
import {
  _arrayLikeToArray,
  _classCallCheck,
  _createClass,
...
var require_chunk = __commonJS({
  '../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/chunk.js'(exports, module) {
    ...
    function chunk2(array, size2, guard) {
      ...
      var index = 0,
        resIndex = 0,
        result = Array(nativeCeil(length / size2));
      while (index < length) {
...
var require_baseRange = __commonJS({
  '../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/_baseRange.js'(exports, module) {
    ...
    function baseRange(start2, end2, step, fromRight) {
      var index = -1,
        length = nativeMax(nativeCeil((end2 - start2) / (step || 1)), 0),
        result = Array(length);
      while (length--) {
    ...
    var defaults2 = baseRest(function (object, sources) {
      ...
      while (++index < length) {
        ...
        while (++propsIndex < propsLength) {
          ...
          if (
            value === void 0 ||
            (eq2(value, objectProto[key]) && !hasOwnProperty.call(object, key))
          ) {
...
var require_assignValue = __commonJS({
  '../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/_assignValue.js'(exports, module) {
    ...
    function assignValue(object, key, value) {
      var objValue = object[key];
      if (
        !(hasOwnProperty.call(object, key) && eq2(objValue, value)) ||
    ...
    !(function (e, i) {
      'object' == typeof exports && 'undefined' != typeof module
        ...
        : 'function' == typeof define && define.amd
          ? define(i)
          : ((e =
              'undefined' != typeof globalThis ? globalThis : e || self).dayjs_plugin_isBetween =
              i());
    })(exports, function () {
      'use strict';
      return function (e, i, t) {
        i.prototype.isBetween = function (e2, i2, s, f) {
          var n = t(e2),
            ...
            u = ')' === f[1];
          return (
            ((r2 ? this.isAfter(n, s) : !this.isBefore(n, s)) &&
              (u ? this.isBefore(o, s) : !this.isAfter(o, s))) ||
            ((r2 ? this.isBefore(n, s) : !this.isAfter(n, s)) &&
    ...
    !(function (n, e) {
      'object' == typeof exports && 'undefined' != typeof module
        ...
        : 'function' == typeof define && define.amd
          ? define(e)
          : ((n =
              'undefined' != typeof globalThis ? globalThis : n || self).dayjs_plugin_localeData =
              e());
    })(exports, function () {
      'use strict';
  ...
  '../node_modules/.pnpm/dayjs@1.11.13/node_modules/dayjs/plugin/minMax.js'(exports, module) {
    !(function (e, n) {
      'object' == typeof exports && 'undefined' != typeof module
        ...
        : 'function' == typeof define && define.amd
          ? define(n)
          : ((e = 'undefined' != typeof globalThis ? globalThis : e || self).dayjs_plugin_minMax =
              n());
    })(exports, function () {
      'use strict';
      return function (e, n, t) {
        var i = function (e2, n2) {
          if (
            ...
            !n2.length ||
            (1 === n2.length && !n2[0]) ||
            (1 === n2.length && Array.isArray(n2[0]) && !n2[0].length)
          )
            return null;
          var t2;
  ...
  '../node_modules/.pnpm/dayjs@1.11.13/node_modules/dayjs/plugin/utc.js'(exports, module) {
    !(function (t, i) {
      'object' == typeof exports && 'undefined' != typeof module
        ...
        : 'function' == typeof define && define.amd
          ? define(i)
          : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).dayjs_plugin_utc =
              i());
    })(exports, function () {
      'use strict';
      var t = 'minute',
...
// ../node_modules/.pnpm/dayjs@1.11.13/node_modules/dayjs/plugin/isLeapYear.js
var require_isLeapYear = __commonJS({
  '../node_modules/.pnpm/dayjs@1.11.13/node_modules/dayjs/plugin/isLeapYear.js'(exports, module) {
    !(function (e, t) {
      'object' == typeof exports && 'undefined' != typeof module
        ? (module.exports = t())
        : 'function' == typeof define && define.amd
          ? define(t)
          : ((e =
              'undefined' != typeof globalThis ? globalThis : e || self).dayjs_plugin_isLeapYear =
              t());
    })(exports, function () {
      'use strict';
      return function (e, t) {
...
// ../node_modules/.pnpm/@babel+runtime@7.27.6/node_modules/@babel/runtime/helpers/esm/callSuper.js
...
// ../node_modules/.pnpm/react-big-calendar@1.19.4_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/react-big-calendar/dist/react-big-calendar.esm.js
...
function polyfill(Component2) {
  ...
  if (
    typeof Component2.getDerivedStateFromProps !== 'function' &&
...
function uncontrollable(Component2, controlledValues, methods) {
  ...
  var UncontrolledComponent = (function (_React$Component) {
      ...
      controlledProps.forEach(function (propName) {
        ...
        var handleChange = function handleChange2(value) {
          if (_this.props[handlerName]) {
            ...
            for (
              var _len2 = arguments.length, args2 = new Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1;
              _key2 < _len2;
              _key2++
            ) {
            ...
            _this.setState(function (_ref) {
              ...
              return {
                values: _extends(
                  ...
                  values2,
                  ((_extends2 = {}), (_extends2[propName] = value), _extends2),
                ),
              };
            });
        };
    ...
    UncontrolledComponent2.getDerivedStateFromProps = function getDerivedStateFromProps(
      props,
      _ref2,
    ) {
...
function addMonths(d, num) {
  var year2 = d.getFullYear(),
    month2 = d.getMonth(),
    day2 = d.getDate(),
    totalMonths = year2 * 12 + month2 + num,
    nextYear = Math.trunc(totalMonths / 12),
    nextMonth = totalMonths % 12,
    nextDay = Math.min(day2, daysOf(nextYear)[nextMonth]);
...
function createAccessor(method) {
  ...
  return function (d, val) {
    ...
    if (
      ...
      (method === 'Hours' ||
        (val >= hourLength && dateOut.getHours() - d.getHours() < Math.floor(val / hourLength)))
    ) {
...
function offsetParent(node) {
  ...
  while (
    ...
    css_default(parent, 'position') === 'static'
  ) {
...
function getTrueOffsetParent(element) {
  if (
    !isHTMLElement3(element) || // https://github.com/popperjs/popper-core/issues/837
...
function getOffsetParent(element) {
  ...
  while (
    offsetParent2 &&
    isTableElement(offsetParent2) &&
    getComputedStyle2(offsetParent2).position === 'static'
  ) {
    offsetParent2 = getTrueOffsetParent(offsetParent2);
  }
  if (
    offsetParent2 &&
    (getNodeName(offsetParent2) === 'html' ||
      (getNodeName(offsetParent2) === 'body' &&
        getComputedStyle2(offsetParent2).position === 'static'))
  ) {
    return window2;
  }
...
function arrow(_ref) {
  ...
  state.modifiersData[name] =
    ...
    (_state$modifiersData$[axisProp] = offset3),
    (_state$modifiersData$.centerOffset = offset3 - center),
    _state$modifiersData$);
}
...
function mapToStyles(_ref2) {
  ...
  if (adaptive) {
    ...
    if (placement === top || ((placement === left || placement === right) && variation === end)) {
      sideY = bottom;
      var offsetY =
        isFixed && offsetParent2 === win && win.visualViewport
...
function getClippingParents(element) {
  ...
  var clipperElement =
    canEscapeClipping && isHTMLElement3(element) ? getOffsetParent(element) : element;
...
function offset2(_ref2) {
  ...
  var _options$offset = options.offset,
    offset3 = _options$offset === void 0 ? [0, 0] : _options$offset;
...
function preventOverflow(_ref) {
  ...
  if (checkMainAxis) {
    ...
    var preventedOffset = within(
      tether ? min2(min3, tetherMin) : min3,
      offset3,
      tether ? max2(max3, tetherMax) : max3,
    );
...
function getCompositeRect(elementOrVirtualElement, offsetParent2, isFixed) {
  ...
  if (isOffsetParentAnElement || (!isOffsetParentAnElement && !isFixed)) {
    if (
      getNodeName(offsetParent2) !== 'body' || // https://github.com/popperjs/popper-core/issues/1078
...
var ariaDescribedByModifier = {
  ...
  fn: function fn2(_ref2) {
    ...
    var _state$elements2 = state.elements,
      popper2 = _state$elements2.popper,
      reference2 = _state$elements2.reference;
    var role =
...
function usePopper(referenceElement, popperElement, _temp) {
  ...
  var _useSafeState = useSafeState_default(
  ...
  var updateModifier = (0, import_react13.useMemo)(
    function () {
      return {
...
function useRootClose(ref, onRootClose, _temp) {
  ...
  var handleMouseCapture = (0, import_react14.useCallback)(
    function (e) {
      var _e$composedPath$;
      ...
      preventMouseRootCloseRef.current =
        ...
        !!contains(
          currentTarget,
          (_e$composedPath$ = e.composedPath == null ? void 0 : e.composedPath()[0]) != null
            ? _e$composedPath$
            : e.target,
        );
    },
...
function useDropdownMenu(options) {
  ...
  var alignEnd =
    (context == null ? void 0 : context.alignEnd) == null ? options.alignEnd : context.alignEnd;
...
function DropdownMenu(_ref2) {
  ...
  return import_react15.default.createElement(
    ...
    null,
    meta.hasShown ? children(props, meta) : null,
  );
}
...
function useDropdownToggle() {
  var _ref = (0, import_react16.useContext)(DropdownContext_default) || {},
    _ref$show = _ref.show,
    show = _ref$show === void 0 ? false : _ref$show,
    _ref$toggle = _ref.toggle,
    toggle = _ref$toggle === void 0 ? noop7 : _ref$toggle,
    setToggle = _ref.setToggle;
  var handleClick = (0, import_react16.useCallback)(
    function (e) {
      toggle(!show, e);
    },
    [show, toggle],
...
function useRefWithUpdate() {
  ...
  var attachRef = (0, import_react17.useCallback)(
    function (element) {
      ref.current = element;
      forceUpdate();
    },
...
function Dropdown(_ref) {
  ...
  var toggle = (0, import_react17.useCallback)(
    function (nextShow, event) {
      onToggle(nextShow, event);
    },
    [onToggle],
  );
  var context = (0, import_react17.useMemo)(
    function () {
      return {
        toggle,
        drop,
  ...
  useGlobalListener('keydown', function (event) {
    ...
    var fromMenu =
      (_menuRef$current = menuRef.current) == null ? void 0 : _menuRef$current.contains(target);
    var fromToggle =
  ...
  return import_react17.default.createElement(
    DropdownContext_default.Provider,
    {
      value: context,
    },
    children,
...
var ModalManager = (function () {
  ...
  _proto.setContainerStyle = function setContainerStyle(containerState, container) {
    ...
    if (containerState.overflowing) {
      style2.paddingRight =
        parseInt(css_default(container, 'paddingRight') || '0', 10) + this.scrollbarSize + 'px';
    }
...
var Modal = (0, import_react21.forwardRef)(function (_ref, ref) {
  var _ref$show = _ref.show,
    ...
    onHide2 = _ref$onHide === void 0 ? function () {} : _ref$onHide,
    onExit = _ref.onExit,
  ...
  var _useState = (0, import_react21.useState)(!show),
    exited = _useState[0],
  ...
  if (Transition) {
    dialog = import_react21.default.createElement(
      Transition,
      {
        appear: true,
        unmountOnExit: true,
  ...
  if (backdrop) {
    ...
    if (BackdropTransition) {
      backdropElement = import_react21.default.createElement(
        BackdropTransition,
        {
          appear: true,
          in: !!show,
...
var propTypes4 = {
   ...
   */
  backdrop: import_prop_types4.default.oneOfType([
    import_prop_types4.default.bool,
    import_prop_types4.default.oneOf(['static']),
  ]),
  /**
...
var Overlay = import_react23.default.forwardRef(function (props, outerRef) {
  var flip2 = props.flip,
    offset3 = props.offset,
  ...
  var _useState = (0, import_react23.useState)(!props.show),
    exited = _useState[0],
    setExited = _useState[1];
  var _usePopper = usePopper_default(
      target,
      rootElement,
      mergeOptionsWithPopperConfig({
        placement,
    ...
    popper2 = _objectWithoutPropertiesLoose(_usePopper, ['styles', 'attributes']);
  if (props.show) {
  ...
  if (Transition) {
    ...
    child = import_react23.default.createElement(
      Transition,
      {
        in: props.show,
        appear: true,
...
Overlay.propTypes = {
  ...
  onHide: function onHide(props) {
    ...
    if (props.rootClose) {
      var _PropTypes$func;
      return (_PropTypes$func = import_prop_types5.default.func).isRequired.apply(
        _PropTypes$func,
        [props].concat(args),
      );
    }
...
var Portal = function Portal2(_ref) {
  ...
  return resolvedContainer
    ? import_react24.default.createElement(
        ...
        null,
        import_react_dom4.default.createPortal(children, resolvedContainer),
      )
    : null;
};
...
import_prop_types7.default.func;
import_prop_types7.default.oneOfType([
  import_prop_types7.default.arrayOf(import_prop_types7.default.oneOf(viewNames$1)),
  import_prop_types7.default.objectOf(function (prop, key) {
    ...
    if (isBuiltinView) {
      ...
      return import_prop_types7.default.elementType.apply(
        import_prop_types7.default,
...
import_prop_types7.default.oneOfType([
  import_prop_types7.default.oneOf(['overlap', 'no-overlap']),
  import_prop_types7.default.func,
]);
var MILLI = {
  seconds: 1e3,
...
function visibleDays(date2, localizer) {
  var current = firstVisibleDay(date2, localizer),
    last = lastVisibleDay(date2, localizer),
    days = [];
...
function isJustDate(date2) {
  return (
    hours(date2) === 0 && minutes(date2) === 0 && seconds(date2) === 0 && milliseconds(date2) === 0
  );
}
...
function diff2(dateA, dateB, unit) {
  ...
  return Math.round(
    Math.abs(+startOf(dateA, unit) / MILLI[unit] - +startOf(dateB, unit) / MILLI[unit]),
  );
}
var localePropType = import_prop_types7.default.oneOfType([
  import_prop_types7.default.string,
  import_prop_types7.default.func,
]);
...
function inEventRange(_ref2) {
  var _ref2$event = _ref2.event,
    start2 = _ref2$event.start,
    end2 = _ref2$event.end,
  ...
  return _createClass(Toolbar2, [
    {
      ...
      value: function render() {
        var _this$props = this.props,
          messages2 = _this$props.localizer.messages,
  ...
  return _createClass(EventCell2, [
    {
      ...
      value: function render() {
        var _this$props = this.props,
          ...
          continuesPrior2 = _this$props.continuesPrior,
          continuesAfter2 = _this$props.continuesAfter,
          accessors = _this$props.accessors,
          getters = _this$props.getters,
          children = _this$props.children,
          _this$props$component = _this$props.components,
          Event2 = _this$props$component.event,
        ...
        var showAsAllDay =
          isAllDay || allDay || localizer.diff(start2, localizer.ceil(end2, 'day'), 'day') > 1;
        var userProps = getters.eventProp(event, start2, end2, selected);
        var content = import_react25.default.createElement(
          'div',
          {
          ...
          Event2
            ? import_react25.default.createElement(Event2, {
                event,
...
function dateCellSelection(start2, rowBox, box, slots, rtl) {
  ...
  if (isStartRow) {
    startIdx = endIdx = rtl
      ? lastSlotIdx - Math.floor((start2.x - rowBox.left) / cellWidth)
      : Math.floor((start2.x - rowBox.left) / cellWidth);
    if (isCurrentRow) {
...
function getPosition(_ref) {
  var target = _ref.target,
    ...
    box = _ref.box;
  var _getOffset = offset(target),
    top2 = _getOffset.top,
    left2 = _getOffset.left,
    width = _getOffset.width,
    height2 = _getOffset.height;
  var _getOffset2 = offset(container),
    cTop = _getOffset2.top,
    cLeft = _getOffset2.left,
    cWidth = _getOffset2.width,
    cHeight = _getOffset2.height;
  var _getOffset3 = offset(box),
...
function CalOverlay(_ref) {
  ...
  var position2 = overlay.position,
...
PopOverlay.propTypes = {
  popupOffset: import_prop_types7.default.oneOfType([
...
var Selection = (function () {
  function Selection2(node) {
    var _ref3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
      ...
      global2 = _ref3$global === void 0 ? false : _ref3$global,
    ...
    this._removeTouchMoveWindowListener = addEventListener2('touchmove', function () {}, window);
    ...
    this._removeDragOverFromOutsideListener = addEventListener2(
      'dragover',
  ...
  return _createClass(Selection2, [
    ...
    },
    {
      ...
      value: function _addInitialEventListener() {
        ...
        var removeMouseDownListener = addEventListener2('mousedown', function (e) {
          ...
          _this2._removeInitialEventListener = addEventListener2(
            'mousedown',
      ...
      value: function _handleInitialEvent(e) {
        ...
        if (!this.globalMouse && node && !contains(node, e.target)) {
          var _normalizeDistance = normalizeDistance(0),
            top2 = _normalizeDistance.top,
            left2 = _normalizeDistance.left,
            bottom2 = _normalizeDistance.bottom,
            right2 = _normalizeDistance.right;
    ...
    },
    {
      ...
      value: function _handleMoveEvent(e) {
        ...
        var left2 = Math.min(pageX, x),
          top2 = Math.min(pageY, y),
          old = this.selecting;
...
function getBoundsForNode(node) {
  ...
  var rect = node.getBoundingClientRect(),
    left2 = rect.left + pageOffset('left'),
    top2 = rect.top + pageOffset('top');
  return {
    top: top2,
    left: left2,
...
var BackgroundCells = (function (_React$Component) {
  ...
  return _createClass(BackgroundCells2, [
    ...
    },
    {
      ...
      value: function render() {
        var _this$props = this.props,
          range2 = _this$props.range,
          getNow2 = _this$props.getNow,
          getters = _this$props.getters,
        ...
        return import_react25.default.createElement(
          ...
          range2.map(function (date2, index) {
            ...
            var _getters$dayProp = getters.dayProp(date2),
              className = _getters$dayProp.className,
              style2 = _getters$dayProp.style;
            return import_react25.default.createElement(
              Wrapper,
              {
                key: index,
              ...
              import_react25.default.createElement('div', {
                ...
                className: clsx_m_default(
                  ...
                  localizer.isSameDate(date2, current) && 'rbc-today',
                  currentDate && localizer.neq(currentDate, date2, 'month') && 'rbc-off-range-bg',
                ),
              }),
            );
          }),
        ...
        while (current <= slots) {
          ...
          if (!event) {
            ...
            if (hiddenEvents.length > 0) {
              ...
              row.push(
                EventRowMixin.renderSpan(slots, 1, key, this.renderShowMore(segments, current)),
              );
    ...
    },
    {
      ...
      value: function renderShowMore(segments, slot) {
        ...
        var _this$props2 = this.props,
          ...
          components2 = _this$props2.components;
        ...
        if (components2 !== null && components2 !== void 0 && components2.showMore) {
          ...
          return count
            ? import_react25.default.createElement(ShowMore, {
                localizer,
                slotDate,
                slot,
                count,
  ...
  function DateContentRow2() {
    ...
    _this.renderHeadingCell = function (date2, index) {
      ...
      return renderHeader({
        ...
        className: clsx_m_default(
          'rbc-date-cell',
          localizer.isSameDate(date2, getNow2()) && 'rbc-now',
        ),
      });
    };
        ...
        import_react25.default.createElement(
          ...
          renderHeader &&
            import_react25.default.createElement(
              ...
              range2.map(_this.renderHeadingCell),
            ),
          import_react25.default.createElement(
            'div',
            {
    ...
    },
    {
      ...
      value: function render() {
        var _this$props5 = this.props,
          date2 = _this$props5.date,
          rtl = _this$props5.rtl,
          range2 = _this$props5.range,
          ...
          components2 = _this$props5.components,
          getNow2 = _this$props5.getNow,
          ...
          import_react25.default.createElement(
            ...
            renderHeader &&
              import_react25.default.createElement(
                ...
                range2.map(this.renderHeadingCell),
              ),
            import_react25.default.createElement(
  ...
  function MonthView2() {
    ...
    _this.renderWeek = function (week, weekIdx) {
      var _this$props = _this.props,
        ...
        components2 = _this$props.components,
        selectable = _this$props.selectable,
        getNow2 = _this$props.getNow,
        selected = _this$props.selected,
        date2 = _this$props.date,
        localizer = _this$props.localizer,
      ...
      },
      {
        ...
        value: function render() {
          var _this$props4 = this.props,
            date2 = _this$props4.date,
            localizer = _this$props4.localizer,
            className = _this$props4.className,
            month2 = localizer.visibleDays(date2, localizer),
            weeks = (0, import_chunk.default)(month2, 7);
          ...
          var overlay =
            (_this$state$overlay =
              (_this$state2 = this.state) === null || _this$state2 === void 0
                ? void 0
                : _this$state2.overlay) !== null && _this$state$overlay !== void 0
              ? _this$state$overlay
              : {};
          var _this$props6 = this.props,
            accessors = _this$props6.accessors,
            localizer = _this$props6.localizer,
            components2 = _this$props6.components,
...
var getKey3 = function getKey4(_ref) {
  var min3 = _ref.min,
    ...
    localizer = _ref.localizer;
  return (
    ''.concat(+localizer.startOf(min3, 'minutes')) +
    ''.concat(+localizer.startOf(max3, 'minutes')) +
    ''.concat(step, '-').concat(slots)
  );
};
function getSlotMetrics(_ref2) {
  var start2 = _ref2.min,
    end2 = _ref2.max,
    step = _ref2.step,
  ...
  return {
    ...
    getRange: function getRange(rangeStart, rangeEnd, ignoreMin, ignoreMax) {
      ...
      var top2 =
        rangeEndMin > step * numSlots && !localizer.eq(end2, rangeEnd)
...
var Event = (function () {
  function Event2(data, _ref) {
    ...
    var _slotMetrics$getRange = slotMetrics.getRange(accessors.start(data), accessors.end(data)),
      start2 = _slotMetrics$getRange.start,
      startDate = _slotMetrics$getRange.startDate,
      end2 = _slotMetrics$getRange.end,
      endDate = _slotMetrics$getRange.endDate,
      top2 = _slotMetrics$getRange.top,
      height2 = _slotMetrics$getRange.height;
    this.start = start2;
    this.end = end2;
...
function sortByRender(events) {
  var sortedByTime = (0, import_sortBy.default)(events, [
    'startMs',
    function (e) {
      return -e.endMs;
    },
...
function noOverlap(_ref) {
  ...
  for (var _i4 = 0; _i4 < styledEvents.length; ++_i4) {
    ...
    for (var _j4 = 0; _j4 < se.friends.length; ++_j4)
      if (se.friends[_j4].idx !== void 0) bitmap[se.friends[_j4].idx] = 0;
...
function TimeGridEvent(props) {
  var style2 = props.style,
    ...
    label = props.label,
    continuesPrior2 = props.continuesPrior,
    continuesAfter2 = props.continuesAfter,
    getters = props.getters,
    ...
    Event2 = _props$components.event,
  ...
  var height2 = style2.height,
    top2 = style2.top,
    width = style2.width,
    xOffset = style2.xOffset;
  var eventStyle = _objectSpread2(
  ...
  function DayColumn2() {
    ...
    _this.renderEvents = function (_ref) {
      ...
      return styledEvents.map(function (_ref2, idx) {
        ...
        var start2 = accessors.start(event);
        var key =
          (_accessors$eventId = accessors.eventId(event)) !== null && _accessors$eventId !== void 0
            ? _accessors$eventId
            : 'evt_' + idx;
    ...
    _this._selectable = function () {
      ...
      var maybeSelect = function maybeSelect2(box) {
        ...
        var start2 = state.startDate,
          end2 = state.endDate;
        if (onSelecting) {
          if (
            (localizer.eq(current.startDate, start2, 'minutes') &&
              localizer.eq(current.endDate, end2, 'minutes')) ||
            onSelecting({
              start: start2,
              end: end2,
  ...
  return _createClass(DayColumn2, [
    ...
    },
    {
      ...
      value: function componentDidUpdate(prevProps, prevState) {
        ...
        var _this$props3 = this.props,
          ...
          localizer = _this$props3.localizer,
          date2 = _this$props3.date,
          min3 = _this$props3.min,
          max3 = _this$props3.max;
        ...
        if (prevProps.isNow !== isNow || getNowChanged) {
          ...
          if (isNow) {
            var tail =
              !getNowChanged &&
              localizer.eq(prevProps.date, date2, 'minutes') &&
              prevState.timeIndicatorPosition === this.state.timeIndicatorPosition;
            this.setTimeIndicatorPositionUpdateInterval(tail);
          }
        } else if (
          isNow &&
          (localizer.neq(prevProps.min, min3, 'minutes') ||
            localizer.neq(prevProps.max, max3, 'minutes'))
        ) {
    ...
    },
    {
      ...
      value: function positionTimeIndicator() {
        var _this$props4 = this.props,
          min3 = _this$props4.min,
          max3 = _this$props4.max,
          getNow2 = _this$props4.getNow;
        var current = getNow2();
    ...
    },
    {
      ...
      value: function render() {
        var _this$props5 = this.props,
          ...
          components2 = _objectWithoutProperties(_this$props5$componen, _excluded2$1);
        this.slotMetrics = this.slotMetrics.update(this.props);
        var slotMetrics = this.slotMetrics;
        var _this$state = this.state,
          selecting = _this$state.selecting,
          top2 = _this$state.top,
          height2 = _this$state.height,
        ...
        var _dayProp = dayProp(max3, resource),
          className = _dayProp.className,
          style2 = _dayProp.style;
        ...
        return import_react25.default.createElement(
          ...
          isNow &&
            ...
            import_react25.default.createElement(
              ...
              timeIndicatorProps,
              import_react25.default.createElement('div', timeIndicatorProps),
            ),
        );
      },
    },
          ...
          return import_react25.default.createElement(
            'div',
            {
              ...
              className: clsx_m_default(
                'rbc-header',
                className,
                localizer.isSameDate(date2, today) && 'rbc-today',
              ),
            },
            drilldownView
              ? import_react25.default.createElement(
              ...
              : import_react25.default.createElement('span', null, header),
          );
        });
      },
    },
    {
      ...
      value: function render() {
        ...
        var _this$props3 = this.props,
          ...
          range2 = _this$props3.range,
          events = _this$props3.events,
          getNow2 = _this$props3.getNow,
          accessors = _this$props3.accessors,
          selectable = _this$props3.selectable,
          components2 = _this$props3.components,
          getters = _this$props3.getters,
          scrollRef = _this$props3.scrollRef,
          localizer = _this$props3.localizer,
          isOverflowing2 = _this$props3.isOverflowing,
          _this$props3$componen = _this$props3.components,
          TimeGutterHeader = _this$props3$componen.timeGutterHeader,
          _this$props3$componen2 = _this$props3$componen.resourceHeader,
          ResourceHeaderComponent =
            _this$props3$componen2 === void 0 ? ResourceHeader : _this$props3$componen2,
        ...
        return import_react25.default.createElement(
          ...
          import_react25.default.createElement(
            ...
            TimeGutterHeader && import_react25.default.createElement(TimeGutterHeader, null),
          ),
              ...
              import_react25.default.createElement(
                'div',
                {
                  className: 'rbc-row rbc-time-header-cell'.concat(
                    range2.length <= 1 ? ' rbc-time-header-cell-single-day' : '',
                  ),
                },
                _this3.renderHeaderCells(range2),
              ),
              import_react25.default.createElement(DateContentRow, {
                isAllDay: true,
                rtl,
                getNow: getNow2,
                minRows: 2,
  ...
  return _createClass(TimeGridHeaderResources2, [
    {
      ...
      value: function renderHeaderCells(range2) {
        ...
        var _this$props = this.props,
          ...
          ResourceHeaderComponent =
            _this$props$component3 === void 0 ? ResourceHeader : _this$props$component3,
            ...
            import_react25.default.createElement(
              ...
              resources.map(function (_ref3, idx2) {
                ...
                var filteredEvents = (groupedEvents.get(id) || []).filter(function (event) {
                  return (
                    localizer.isSameDate(event.start, date2) ||
                    localizer.isSameDate(event.end, date2)
                  );
                });
                return import_react25.default.createElement(DateContentRow, {
                  key: 'resource_'.concat(id, '_').concat(idx2),
    ...
    },
    {
      ...
      value: function render() {
        var _this$props2 = this.props,
          ...
          isOverflowing2 = _this$props2.isOverflowing,
...
var TimeGutter = function TimeGutter2(_ref2) {
  ...
  var _useMemo = (0, import_react25.useMemo)(
      ...
      [
        min3 === null || min3 === void 0 ? void 0 : min3.toISOString(),
        max3 === null || max3 === void 0 ? void 0 : max3.toISOString(),
        localizer,
      ],
    ),
    start2 = _useMemo.start,
    end2 = _useMemo.end;
  ...
  (0, import_react25.useEffect)(
    ...
    [
      start2 === null || start2 === void 0 ? void 0 : start2.toISOString(),
      end2 === null || end2 === void 0 ? void 0 : end2.toISOString(),
      timeslots,
      step,
    ],
  );
  var renderSlot = (0, import_react25.useCallback)(
    function (value, idx) {
      if (idx) return null;
  ...
  return _createClass(TimeGrid2, [
    ...
    },
    {
      ...
      value: function renderDayColumn(
        ...
        var _this$props2 = this.props,
          min3 = _this$props2.min,
          max3 = _this$props2.max;
    ...
    },
    {
      ...
      value: function render() {
        ...
        var _this$props4 = this.props,
          ...
          components2 = _this$props4.components,
        ...
        return import_react25.default.createElement(
          ...
          resources && resources.length > 1 && resourceGroupingLayout
            ? import_react25.default.createElement(TimeGridHeaderResources, headerProps)
            : import_react25.default.createElement(TimeGridHeader, headerProps),
          this.props.popup && this.renderOverlay(),
          import_react25.default.createElement(
            'div',
            {
    ...
    },
    {
      ...
      value: function calculateScroll() {
        ...
        var diffMillis = localizer.diff(
          localizer.merge(scrollToTime, min3),
          scrollToTime,
          'milliseconds',
        );
        ...
        var _this$props = this.props,
          ...
          min3 =
            _this$props$min === void 0
              ? localizer.startOf(/* @__PURE__ */ new Date(), 'day')
              : _this$props$min,
          _this$props$max = _this$props.max,
          max3 =
            _this$props$max === void 0
              ? localizer.endOf(/* @__PURE__ */ new Date(), 'day')
              : _this$props$max,
...
function Agenda(_ref) {
  ...
  var renderDay = function renderDay2(day2, events2, dayKey) {
    var Event2 = components2.event,
      AgendaDate = components2.date;
    events2 = events2.filter(function (e) {
      return inRange2(
        e,
        localizer.startOf(day2, 'day'),
        localizer.endOf(day2, 'day'),
        accessors,
        localizer,
      );
    });
      ...
      var first =
        idx === 0
          ? import_react25.default.createElement(
              ...
              AgendaDate
                ? import_react25.default.createElement(AgendaDate, {
                    day: day2,
                    label: dateLabel,
                  })
                : dateLabel,
  ...
  var timeRangeLabel = function timeRangeLabel2(day2, event) {
    var labelClass = '',
      TimeComponent = components2.time,
    ...
    return import_react25.default.createElement(
      ...
      TimeComponent
        ? import_react25.default.createElement(TimeComponent, {
            event,
            day: day2,
            label,
          })
  ...
  events = events.filter(function (event) {
    return inRange2(
      event,
      localizer.startOf(date2, 'day'),
      localizer.endOf(end2, 'day'),
      accessors,
      localizer,
    );
  });
...
var VIEWS = _defineProperty(
  _defineProperty(
    _defineProperty(
      _defineProperty(_defineProperty({}, views.MONTH, MonthView), views.WEEK, Week),
      views.WORK_WEEK,
      WorkWeek,
    ),
    views.DAY,
  ...
  function Calendar2() {
    ...
    _this.getViews = function () {
      ...
      if (Array.isArray(views2)) {
        return (0, import_transform.default)(
          views2,
          function (obj, name) {
    ...
    [
      {
        ...
        value: function render() {
          ...
          var _this$state$context = this.state.context,
            ...
            components2 = _this$state$context.components,
            getters = _this$state$context.getters,
            localizer = _this$state$context.localizer,
            viewNames2 = _this$state$context.viewNames;
          ...
          return import_react25.default.createElement(
            ...
            toolbar &&
              import_react25.default.createElement(CalToolbar, {
                date: current,
                view,
                views: viewNames2,
                label,
      ...
      },
      {
        ...
        value: function getContext(_ref2) {
          var startAccessor = _ref2.startAccessor,
            ...
            components2 = _ref2$components === void 0 ? {} : _ref2$components,
            _ref2$formats = _ref2.formats,
            formats2 = _ref2$formats === void 0 ? {} : _ref2$formats;
          ...
          return {
            ...
            components: (0, import_defaults.default)(
              components2[view] || {},
              (0, import_omit.default)(components2, names),
              {
...
var weekRangeFormat$5 = function weekRangeFormat(_ref, culture, local) {
  var start2 = _ref.start,
    end2 = _ref.end;
  return (
    local.format(start2, 'MMMM DD', culture) +
...
function moment(moment2) {
  ...
  function getSlotDate2(dt, minutesFromMidnight, offset3) {
    return moment2(dt)
      .startOf('day')
      .minute(minutesFromMidnight + offset3)
      .toDate();
  }
  ...
  function inEventRange2(_ref7) {
    var _ref7$event = _ref7.event,
      start2 = _ref7$event.start,
      end2 = _ref7$event.end,
...
function luxon(DateTime) {
  var _ref6 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
  ...
  function startOfDT() {
    var date2 =
      arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : /* @__PURE__ */ new Date();
    var unit = arguments.length > 1 ? arguments[1] : void 0;
    var datePart = fixUnit$1(unit);
    if (datePart) {
  ...
  function inEventRange2(_ref8) {
    var _ref8$event = _ref8.event,
      start2 = _ref8$event.start,
      end2 = _ref8$event.end,
    ...
    var endsAfterStart = sameMin
      ? gt2(end2, rangeStart, 'minutes')
      : gte2(end2, rangeStart, 'minutes');
    return startsBeforeEnd && endsAfterStart;
  }
  function isSameDate2(date1, date2) {
...
var weekRangeFormat$3 = function weekRangeFormat3(_ref5, culture, local) {
  var start2 = _ref5.start,
    end2 = _ref5.end;
  return (
    local.format(start2, 'MMM dd', culture) +
    ' – ' +
    local.format(end2, eq(start2, end2, 'month') ? 'dd' : 'MMM dd', culture)
  );
};
var formats$3 = {
  dateFormat: 'dd',
...
function globalize(globalize2) {
  ...
  function firstOfWeek(culture) {
    try {
      ...
      if (true) {
        console.error(
          'Failed to accurately determine first day of the week. Is supplemental data loaded into CLDR?',
        );
      }
      var date2 = /* @__PURE__ */ new Date();
      var localeDay = Math.max(
        parseInt(
          locale(culture).formatDate(date2, {
            raw: 'e',
          }),
          10,
        ) - 1,
...
var dateRangeFormat$1 = function dateRangeFormat5(_ref, culture, local) {
  var start2 = _ref.start,
    end2 = _ref.end;
  return ''
    .concat(local.format(start2, 'P', culture), ' – ')
    .concat(local.format(end2, 'P', culture));
};
...
var weekRangeFormat$1 = function weekRangeFormat5(_ref5, culture, local) {
  var start2 = _ref5.start,
    end2 = _ref5.end;
  return ''
    .concat(local.format(start2, 'MMMM dd', culture), ' – ')
    .concat(local.format(end2, eq(start2, end2, 'month') ? 'dd' : 'MMMM dd', culture));
};
var formats$1 = {
  dateFormat: 'dd',
  dayFormat: 'dd eee',
...
function dayjs(dayjsLib) {
  ...
  function firstVisibleDay2(date2) {
    ...
    if (dayjs2(firstDayOfMonth).isLeapYear()) {
      var day2 = firstDayOfMonth.toDate().getDay(),
        _diff = firstDayOfMonth.toDate().getDate() - day2 + (day2 == 0 ? -6 : 1);
