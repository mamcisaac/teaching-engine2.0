  ...
  var weekStartsOn = toInteger(
    (_ref =
      (_ref2 =
        (_ref3 =
          (_options$weekStartsOn =
            options === null || options === void 0 ? void 0 : options.weekStartsOn) !== null &&
          ...
          ? _ref3
          : defaultOptions2.weekStartsOn) !== null && _ref2 !== void 0
        ? _ref2
        : (_defaultOptions$local = defaultOptions2.locale) === null ||
...
function isDate(value) {
  ...
  return (
    ...
    (_typeof(value) === 'object' && Object.prototype.toString.call(value) === '[object Date]')
  );
}
...
function differenceInCalendarISOWeeks(dirtyDateLeft, dirtyDateRight) {
  ...
  var timestampLeft =
    startOfISOWeekLeft.getTime() - getTimezoneOffsetInMilliseconds(startOfISOWeekLeft);
  var timestampRight =
    startOfISOWeekRight.getTime() - getTimezoneOffsetInMilliseconds(startOfISOWeekRight);
...
function differenceInCalendarWeeks(dirtyDateLeft, dirtyDateRight, options) {
  ...
  var timestampRight =
    startOfWeekRight.getTime() - getTimezoneOffsetInMilliseconds(startOfWeekRight);
  ...
  var firstWeekContainsDate = toInteger(
    (_ref =
      (_ref2 =
        (_ref3 =
          (_options$firstWeekCon =
            options === null || options === void 0 ? void 0 : options.firstWeekContainsDate) !==
          ...
          ? _ref3
          : defaultOptions2.firstWeekContainsDate) !== null && _ref2 !== void 0
        ? _ref2
        : (_defaultOptions$local = defaultOptions2.locale) === null ||
            _defaultOptions$local === void 0
          ? void 0
...
function format(dirtyDate, dirtyFormatStr, options) {
  ...
  var locale2 =
    (_ref =
      (_options$locale = options === null || options === void 0 ? void 0 : options.locale) !==
        null && _options$locale !== void 0
        ? _options$locale
        : defaultOptions2.locale) !== null && _ref !== void 0
      ? _ref
    ...
    (_ref2 =
      (_ref3 =
        (_ref4 =
          ...
          ? _ref4
          : defaultOptions2.firstWeekContainsDate) !== null && _ref3 !== void 0
        ? _ref3
        : (_defaultOptions$local = defaultOptions2.locale) === null ||
            _defaultOptions$local === void 0
          ? void 0
    ...
    (_ref5 =
      (_ref6 =
        (_ref7 =
          ...
          ? _ref7
          : defaultOptions2.weekStartsOn) !== null && _ref6 !== void 0
        ? _ref6
        : (_defaultOptions$local3 = defaultOptions2.locale) === null ||
...
function formatDistanceStrict(dirtyDate, dirtyBaseDate, options) {
  ...
  var roundingMethod = String(
    (_options$roundingMeth =
      options === null || options === void 0 ? void 0 : options.roundingMethod) !== null &&
  ...
  var timezoneOffset =
    getTimezoneOffsetInMilliseconds(dateRight) - getTimezoneOffsetInMilliseconds(dateLeft);
...
function formatDuration(duration, options) {
  ...
  var zero =
    ...
    _options$zero !== void 0
      ...
      : false;
  var delimiter =
    (_options$delimiter = options === null || options === void 0 ? void 0 : options.delimiter) !==
...
function formatISO(date, options) {
  ...
  var representation = String(
    (_options$representati =
      options === null || options === void 0 ? void 0 : options.representation) !== null &&
...
function formatISODuration(duration) {
  ...
  var _duration$years = duration.years,
    ...
    months2 = _duration$months === void 0 ? 0 : _duration$months,
    _duration$days = duration.days,
    days2 = _duration$days === void 0 ? 0 : _duration$days,
...
function formatRFC3339(dirtyDate, options) {
  ...
  var fractionDigits = Number(
    (_options$fractionDigi =
      options === null || options === void 0 ? void 0 : options.fractionDigits) !== null &&
    ...
    (_ref2 =
      (_ref3 =
        (_ref4 =
          ...
          ? _ref4
          : defaultOptions2.weekStartsOn) !== null && _ref3 !== void 0
        ? _ref3
        : (_defaultOptions$local = defaultOptions2.locale) === null ||
            _defaultOptions$local === void 0
          ? void 0
...
function _createForOfIteratorHelper(r, e2) {
  ...
  if (!t2) {
    if (
      Array.isArray(r) ||
      (t2 = _unsupportedIterableToArray(r)) ||
      (e2 && r && 'number' == typeof r.length)
    ) {
      t2 && (r = t2);
      var _n = 0,
        F = function F2() {};
...
function parseISO(argument, options) {
  ...
  var additionalDigits = toInteger(
    (_options$additionalDi =
      options === null || options === void 0 ? void 0 : options.additionalDigits) !== null &&
...
function roundToNearestMinutes(dirtyDate, options) {
  ...
  var nearestTo = toInteger(
    (_options$nearestTo = options === null || options === void 0 ? void 0 : options.nearestTo) !==
