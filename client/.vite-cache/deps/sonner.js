...
var SuccessIcon = import_react.default.createElement(
  'svg',
  {
...
var WarningIcon = import_react.default.createElement(
  'svg',
  {
    xmlns: 'http://www.w3.org/2000/svg',
    viewBox: '0 0 24 24',
...
var InfoIcon = import_react.default.createElement(
  'svg',
  {
    xmlns: 'http://www.w3.org/2000/svg',
    viewBox: '0 0 20 20',
...
var ErrorIcon = import_react.default.createElement(
  'svg',
  {
    xmlns: 'http://www.w3.org/2000/svg',
    viewBox: '0 0 20 20',
...
var CloseIcon = import_react.default.createElement(
  'svg',
  {
    xmlns: 'http://www.w3.org/2000/svg',
    width: '12',
        ...
        .then(async (response) => {
          ...
          if (isReactElementResponse) {
            ...
            const isExtendedResult =
              typeof promiseData === 'object' && !import_react.default.isValidElement(promiseData);
...
var Toast = (props) => {
  ...
  const remainingTime = import_react.default.useRef(
  ...
  const heightIndex = import_react.default.useMemo(
  ...
  const duration = import_react.default.useMemo(
    () => toast2.duration || durationFromToaster || TOAST_LIFETIME,
  ...
  offset.current = import_react.default.useMemo(
  ...
  return import_react.default.createElement(
    ...
    import_react.default.isValidElement(toast2.cancel)
      ? toast2.cancel
      : toast2.cancel && isAction(toast2.cancel)
        ...
        : null,
    import_react.default.isValidElement(toast2.action)
      ? toast2.action
...
var Toaster = import_react.default.forwardRef(function Toaster2(props, ref) {
  ...
  const [actualTheme, setActualTheme] = import_react.default.useState(
    theme !== 'system'
      ? theme
