...
router.get('/alerts', authenticate, asyncHandler(async (_req: Request, res: Response) => {
...
router.post('/alerts/:alertId/trigger', authenticate, asyncHandler(async (req: Request, res: Response) => {
