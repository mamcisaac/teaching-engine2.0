...
export const bilingualLessonTemplates = [
  {
    ...
    content: {
      ...
      mindsOn: 'Begin with a number talk in French. Show the number 235 and ask learners: "Qu\'est-ce que vous voyez?" Encourage mathematical vocabulary.',
      ...
      action: 'Learners work with base-10 blocks to build numbers. Use French mathematical language: unités, dizaines, centaines.',
      ...
      consolidation: 'Learners complete an exit ticket explaining the value of each digit in a 3-digit number.',
      ...
      learningGoals: 'Learners will understand place value in 3-digit numbers',
  ...
  },
  {
    ...
    content: {
      ...
      mindsOn: 'Display weather images. Learners use gestures to show understanding (TPR). Review previous vocabulary.',
      ...
      action: 'Introduce new vocabulary with visuals. Play "Quel temps fait-il?" game. Learners practice in pairs with weather cards.',
      ...
      consolidation: 'Learners draw their favorite weather and write a simple sentence in French.',
      consolidationFr: 'Les élèves dessinent leur météo préférée et écrivent une phrase simple en français.',
      learningGoals: 'Learners will learn 8-10 weather vocabulary words in French',
  ...
  },
  {
    ...
    content: {
      ...
      mindsOn: 'Present mystery objects in bags. Learners feel and describe using property words in both languages.',
      ...
      action: 'Learners investigate objects at stations, recording observations in bilingual science journals.',
      ...
      consolidation: 'Gallery walk to share findings. Learners use sentence frames in both languages.',
      ...
      learningGoals: 'Learners will identify and describe properties of matter',
  ...
  },
  {
    ...
    content: {
      ...
      consolidation: 'Learners share one thing they learned or created. Use talking stick for French oral practice.',
      ...
      learningGoals: 'Learners will practice reading, writing, and word study skills',
  ...
  },
  {
    ...
    content: {
      ...
      learningGoals: 'Learners will develop ball handling skills',
