...
import { isDefined, isError, isObject } from '../../utils/typeGuards';
...
export const commonValidators = {
  ...
  dateRange: z
    ...
    .refine(
      (data) => (data.from === undefined || data.from === '') || (data.to === undefined) || (data.from !== undefined && data.to !== undefined && new Date(data.from) <= new Date(data.to)),
