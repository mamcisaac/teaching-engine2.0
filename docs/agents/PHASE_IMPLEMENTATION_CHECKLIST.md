...
- [x] **Run initial migration**
  ...
  pnpm --filter @teaching-engine/database db:migrate --name init
...
- [x] **Add completedAt field to Activity model**
  ...
  pnpm --filter @teaching-engine/database db:migrate --name add_activity_completion
  ```
...
- [x] **Database Schema Updates**
  ...
  # Run: pnpm --filter @teaching-engine/database db:migrate --name add_lesson_planning
  ```
