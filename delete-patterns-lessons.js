...
async function deletePatternsLessons() {
  console.log('🗑️  DELETING POOR QUALITY PATTERNS AND SORTING LESSONS');
  ...
  try {
    ...
    console.log('1. Create perfect Patterns and Sorting lessons');
    console.log('2. Target: 20-25 lessons over 5 weeks');
    console.log('3. Focus: Repeating patterns, sorting, algebra foundations');
...
deletePatternsLessons().catch(console.error);