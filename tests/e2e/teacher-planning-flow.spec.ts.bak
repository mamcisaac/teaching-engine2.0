...
test.describe('ETFO Teacher Planning Workflow', () => {
  ...
  test('should complete full ETFO planning workflow from curriculum to daybook', async ({
    page,
  }) => {
    ...
    await page
      .locator('[data-testid="expectation-description"]')
      .fill('Students will count to 20 accurately');
    ...
    await page
      .locator('[data-testid="lrp-description"]')
      .fill('Comprehensive mathematics program for Grade 1 students');
    await page
      .locator('[data-testid="lrp-goals"]')
      .fill('Develop number sense, counting skills, and basic operations');
    ...
    await page
      .locator('[data-testid="unit-description"]')
      .fill('Introduction to numbers 1-10 with counting and recognition activities');
    await page
      .locator('[data-testid="unit-big-ideas"]')
      .fill('Numbers represent quantities and have relationships to each other');
    ...
    await page.locator('[data-testid="add-question-btn"]').click();
    await page
      .locator('[data-testid="essential-question-1"]')
      .fill('How do we count objects accurately?');
    ...
    await page
      .locator('[data-testid="minds-on"]')
      .fill('Sing counting songs and show fingers for numbers 1-5');
    await page
      .locator('[data-testid="action"]')
      .fill('Use counting bears to practice counting objects from 1 to 5');
    await page
      .locator('[data-testid="consolidation"]')
      .fill('Share different counting strategies and count classroom objects together');

    // Learning goals
    await page
      .locator('[data-testid="learning-goals"]')
      .fill('Students will count objects accurately from 1 to 5 and recognize number patterns');
    ...
    await page
      .locator('[data-testid="assessment-notes"]')
      .fill('Observe counting accuracy and one-to-one correspondence');
    ...
    await page
      .locator('[data-testid="sub-notes"]')
      .fill(
        'Counting bears are in the red bin on the math shelf. Number cards are in the pocket chart.',
      );
    ...
    await expect(page.locator('[data-testid="lesson-detail-title"]')).toContainText(
      'Counting to 5 with Manipulatives',
    );
    ...
    // Fill out reflection
    await page
      .locator('[data-testid="what-worked"]')
      .fill(
        'Students were very engaged with the counting bears. The visual manipulatives really helped them understand one-to-one correspondence.',
      );
    await page
      .locator('[data-testid="what-didnt-work"]')
      .fill(
        'A few students still struggled with pointing to each object while counting. Need more practice with this skill.',
      );
    await page
      .locator('[data-testid="next-steps"]')
      .fill(
        'Provide more guided practice with pointing while counting. Maybe use larger objects that are easier to point to.',
      );

    await page
      .locator('[data-testid="student-engagement"]')
      .fill('High - students were excited to use the manipulatives and actively participated');
    await page
      .locator('[data-testid="student-successes"]')
      .fill('Most students successfully counted to 5 and understood the concept');
    await page
      .locator('[data-testid="student-challenges"]')
      .fill('Some students counted too quickly without pointing to each object');

    await page.locator('[data-testid="overall-rating"]').selectOption('4');
    await page.locator('[data-testid="would-reuse-lesson"]').check();
    await page
      .locator('[data-testid="general-notes"]')
      .fill('Great lesson overall. Will repeat this format for numbers 6-10 next week.');
    ...
    await page
      ...
      .fill('Counting to 5 with Manipulatives - Updated');
  ...
  test('should support curriculum import confirmation workflow', async ({ page }) => {
    ...
    await page
      ...
      .setInputFiles('tests/e2e/fixtures/sample-curriculum.pdf');
    ...
    await expect(page.locator('[data-testid="expectation-count"]')).toContainText(
      'expectations found',
    );
    ...
    await page
      .locator('[data-testid="edit-expectation-description"]')
      .fill('Updated expectation description');
