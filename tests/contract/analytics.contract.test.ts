...
import { mockDataService } from '../../server/src/services/mockDataService';
import { curriculumAnalyticsService } from '../../server/src/services/analytics/curriculumAnalyticsSimple';
import { domainAnalyticsService } from '../../server/src/services/analytics/domainAnalyticsSimple';
import { themeAnalyticsService } from '../../server/src/services/analytics/themeAnalyticsSimple';
import { vocabularyAnalyticsService } from '../../server/src/services/analytics/vocabularyAnalyticsSimple';
  ...
  describe('Vocabulary Analytics Contracts', () => {
    it('should match contract for vocabulary growth endpoint', async () => {
      await testContract({
        ...
        mockComparison: async () => {
          return await vocabularyAnalyticsService.generateGrowthAnalysis({
            studentId: 1,
            term: 'Term 1',
          });
        },
    ...
    it('should match contract for vocabulary trends endpoint', async () => {
      await testContract({
        ...
        mockComparison: async () => {
          return await vocabularyAnalyticsService.generateTrendAnalysis({
            studentId: 1,
            timeframe: 'term',
          });
        },
