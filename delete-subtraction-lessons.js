...
async function deleteSubtractionLessons() {
  console.log('🗑️  DELETING POOR QUALITY SUBTRACTION BASICS LESSONS');
  console.log('Removing 25 lessons scoring 30% quality');
  console.log('Critical issues: Wrong duration, no expectations, no differentiation');
  console.log('======================================================');

  const unitPlanId = 'cmectx0p2000nvj4p97h49w9k';
  ...
  try {
    ...
    console.log('1. Create perfect Subtraction Basics lessons');
    console.log('2. Target: 20 lessons over 5 weeks');
    console.log('3. Focus: Subtraction strategies, facts to 20, take away');
...
deleteSubtractionLessons().catch(console.error);