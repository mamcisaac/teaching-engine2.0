# 📚 Grade 1 French Immersion Lesson Enhancement Master Tracking

## 🔴 MANDATORY PRE-WORK FOR ALL AGENTS

### Before Starting ANY Enhancement Work:
1. **READ** `/scripts/knowledge/best-practices-library.cjs` - Contains ETFO standards
2. **STUDY** Quality Examples:
   - `improved-math-lesson-by-agents.json` - Materials format standard
   - `improved-french-lesson-by-agents.json` - Language compliance examples  
   - `nombres-0-10-full-TEST-ENHANCED.json` - Gold standard decision points
3. **UNDERSTAND** Core Principle: "Support teacher thinking, not replace it"

### Quality Standards to Achieve:
- **Decision Points**: Pedagogically meaningful like "Si confusion avec symboles, retourner aux manipulatifs"
- **Materials**: Specific quantities like "15 cubes par élève (375 pour classe de 25)"  
- **French**: Natural Canadian French, not mechanical translation
- **Budget**: Under $50/lesson, NO parent donations

## 📊 Enhancement Tracking Grid (50 Units × 3 Tasks = 150 Items)
...
### Step 1: Agent Reads Unit File
```bash
# Agent reads and comprehends all 20 lessons
Read generated-lessons/[subject]/[unit]-full.json
```

### Step 2: Fix Translations
- Change all "Students will..." → "Les élèves..."
- Ensure natural Canadian French throughout
- Mark: ✅ Translations

### Step 3: Add Decision Points
- Add 0-3 pedagogically meaningful points per lesson
- Early lessons (1-5): 2-3 points
- Middle lessons (6-15): 1-2 points
- Later lessons (16-20): 0-1 points
- Mark: ✅ Decision Points

### Step 4: Specify Materials
- Exact quantities for 20-25 students
- School-available only (NO parent donations)
...
### Step 6: Create Review Feedback
- Save to: `REVIEW_FEEDBACK/[subject]/[unit]-review.md`
- Document strengths and issues
- Mark: ✅ Reviewed
...
- ✅ **COMPLETE DIFFERENTIATION**: Added 4-category differentiation (forStruggling, forAdvanced, forELL, forIEP) for ALL 20 lessons with spring science focus  
- ✅ **ASSESSMENT & VISUAL SUPPORTS**: Comprehensive assessment criteria and visual supports added for all lessons focusing on spring vocabulary, seasonal changes observation, and scientific exploration  
...
- ✅ **SCIENTIFIC PROGRESSION**: Perfect spring exploration from basic spring signs identification to advanced predictions, global comparisons, and scientific experiments  
- ✅ **CORE LESSONS (1-14)**: Spring signs observation, bud awakening, longer days, animal activity, bird nesting, animal families, seed experiments, flower appearance, insect connections, garden creation, science documentation, summer predictions  
- ✅ **EXTENSION LESSONS (15-20)**: Global spring comparisons, experimental design, human spring adaptations, scientific presentations, young scientist celebrations  
- 🎯 **HISTORIC MILESTONE**: Science curriculum reaches 100% completion (10/10 units) - COMPLETE Grade 1 French Immersion science curriculum achieved! 🏆  

**PREVIOUS COMPLETION**: sciences/materiaux (MATERIALS SCIENCE UNIT 100% COMPLETE) 🧪🔬✨
