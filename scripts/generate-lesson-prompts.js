 ...
 */
function generatePerfectPrompt(subject, unitTitle, lessonNumber, totalLessons, month, unitDescription, curriculumExpectations) {
...
function distributeLessonsAcrossUnit(unit, totalLessons, curriculumExpectations) {
    ...
    for (let i = 0; i < totalLessons; i++) {
        ...
        const prompt = generatePerfectPrompt(unit.longRangePlan.subject, unit.title, i + 1, totalLessons, month, unit.description, curriculumExpectations);
        prompts.push({
 ...
 */
function calculateMonthlyDistribution(allPrompts) {
    const distribution = {};
