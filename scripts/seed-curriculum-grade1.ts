...
async function seedGrade1Curriculum() {
  ...
  try {
    ...
    const health = [
      { code: 'S1.1', description: 'Identifier les habitudes de vie saines', strand: 'Santé personnelle', substrand: 'Habitudes' },
      { code: 'S1.2', description: 'Reconnaître l\'importance de l\'hygiène personnelle', strand: 'Santé personnelle', substrand: 'Hygiène' },
      { code: 'S1.3', description: 'Identifier les émotions de base', strand: 'Santé mentale', substrand: 'Émotions' },
      { code: 'S1.4', description: 'Pratiquer des stratégies de gestion du stress', strand: 'Santé mentale', substrand: 'Bien-être' },
      { code: 'S1.5', description: 'Comprendre la sécurité personnelle', strand: 'Sécurité', substrand: 'Protection personnelle' }
    ];
