...
async function checkEducationPhysique() {
  console.log('🔍 CHECKING ÉDUCATION PHYSIQUE LRP');
  console.log('====================================');
  
  // Get Éducation physique LRP
...
checkEducationPhysique().catch(console.error).finally(() => prisma.$disconnect());