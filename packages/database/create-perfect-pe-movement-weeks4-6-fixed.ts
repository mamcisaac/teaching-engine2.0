...
4. Pratique du jeu en petits groupes (10 min)`,
      ...
      assessment: JSON.stringify({
        formative: 'Observation de la capacité à suivre les règles et à jouer de manière coopérative',
        summative: 'Checklist des habiletés de jeu coopératif'
      }),
      ...
      subPlans: "Jeux simples avec règles écrites et illustrées. Focus sur 'Feu rouge, feu vert' et 'Jacques a dit'. Support visuel fourni.",
...
5. Course finale avec toutes les équipes (5 min)`,
      ...
      assessment: JSON.stringify({
        formative: 'Évaluation de la technique de passage, de l\'esprit d\'équipe et de l\'effort',
        summative: 'Temps chronométrés, progrès individuel noté'
      }),
      resources: JSON.stringify([
      ...
      subPlans: "Course de relais avec instructions détaillées. Focus sur le passage de témoin et l'esprit d'équipe. Parcours dessiné inclus.",
      safetyConsiderations: JSON.stringify([
...
5. Carrousel: tourner en tenant le parachute (7 min)`,
      ...
      assessment: JSON.stringify({
        formative: 'Observation de la participation, de l\'écoute des consignes et de la coopération',
        summative: 'Portfolio photo des activités réussies'
      }),
      resources: JSON.stringify([
      ...
      subPlans: "Activités de parachute avec séquence détaillée. Cartes visuelles fournies. Focus sur la sécurité et l'inclusion.",
      safetyConsiderations: JSON.stringify([
...
6. Parcours complet chronométré (10 min)`,
      ...
      assessment: JSON.stringify({
        formative: 'Portfolio de progrès avec temps et observations par station',
        summative: 'Amélioration du temps personnel'
      }),
      resources: JSON.stringify([
      ...
      subPlans: "Parcours d'aventure avec plan détaillé des stations. Instructions et adaptations pour chaque station fournies.",
      safetyConsiderations: JSON.stringify([
...
7. Dessiner un cœur et colorier selon l'intensité (5 min)`,
      ...
      assessment: JSON.stringify({
        formative: 'Capacité à identifier les changements de rythme cardiaque, participation active',
        summative: 'Journal de santé complété'
      }),
      resources: JSON.stringify([
      ...
      subPlans: "Leçon sur le système cardiovasculaire avec activités graduées. Instructions détaillées pour mesurer le pouls incluses.",
      safetyConsiderations: JSON.stringify([
...
8. Défi final: zoo en folie - tous les animaux (5 min)`,
      ...
      assessment: JSON.stringify({
        formative: 'Observation de l\'effort soutenu, de la forme des mouvements et de la persévérance',
        summative: 'Checklist des mouvements maîtrisés'
      }),
      resources: JSON.stringify([
      ...
      subPlans: "Circuit fitness avec mouvements d'animaux. Cartes visuelles et instructions pour chaque station fournies.",
      safetyConsiderations: JSON.stringify([
...
7. Pose de l'enfant (repos) (3 min)`,
      ...
      assessment: JSON.stringify({
        formative: 'Observation de la concentration, de l\'effort pour maintenir les poses et de la respiration',
        summative: 'Auto-évaluation du bien-être'
      }),
      resources: JSON.stringify([
      ...
      subPlans: "Session de yoga guidée avec cartes de poses. Histoire de relaxation et musique calme incluses.",
      safetyConsiderations: JSON.stringify([
...
6. Défi 5: Affiche des bonnes habitudes (8 min)`,
      ...
      assessment: JSON.stringify({
        formative: 'Évaluation de la participation, de la coopération et de la compréhension des concepts de santé',
        summative: 'Affiche de santé créée'
      }),
      resources: JSON.stringify([
      ...
      subPlans: "Défi santé en équipe avec stations détaillées. Cartes de défis et matériel préparé.",
      safetyConsiderations: JSON.stringify([
...
6. Mini-match 3 contre 3 (8 min)`,
      ...
      assessment: JSON.stringify({
        formative: 'Observation du contrôle du ballon, de la participation et du respect des règles',
        summative: 'Démonstration des habiletés de base'
      }),
      resources: JSON.stringify([
      ...
      subPlans: "Introduction au soccer avec progression d'exercices. Plan de terrain et règles simplifiées fournis.",
      safetyConsiderations: JSON.stringify([
...
6. Relais de dribble et lancer (8 min)`,
      ...
      assessment: JSON.stringify({
        formative: 'Évaluation du contrôle du ballon, de la technique de lancer et de l\'effort',
        summative: 'Nombre de paniers réussis, amélioration personnelle'
      }),
      resources: JSON.stringify([
      ...
      subPlans: "Introduction au basketball avec progression d'habiletés. Exercices détaillés et adaptations inclus.",
      safetyConsiderations: JSON.stringify([
...
6. Mini-match 4 contre 4 avec règles adaptées (8 min)`,
      ...
      assessment: JSON.stringify({
        formative: 'Observation de la manipulation sécuritaire, du contrôle et de la coopération',
        summative: 'Démonstration des habiletés de base'
      }),
      resources: JSON.stringify([
      ...
      subPlans: "Hockey sur gazon avec focus sur la sécurité. Règles détaillées et progression d'exercices fournis.",
      safetyConsiderations: JSON.stringify([
...
6. Épreuve 5: Relais final (7 min)`,
      ...
      assessment: JSON.stringify({
        formative: 'Portfolio des performances, observation de l\'esprit sportif et de l\'effort',
        summative: 'Participation complète et démonstration des habiletés'
      }),
      resources: JSON.stringify([
      ...
      subPlans: "Mini-olympiades avec épreuves détaillées. Tout le matériel et les instructions sont préparés.",
      safetyConsiderations: JSON.stringify([
