...
async function linkCurriculumExpectations() {
  ...
  const linkingRules = {
    ...
    'Sciences humaines': [
      { keywords: ['community', 'communauté', 'culture', 'society'], priority: 1 },
      { keywords: ['identity', 'identité', 'tradition'], priority: 2 },
      { keywords: ['citizen', 'citoyen', 'role'], priority: 2 }
    ],
    'Arts visuels': [
    ...
    'Formation personnelle et sociale': [
      { keywords: ['health', 'santé', 'emotion', 'feeling'], priority: 1 },
      { keywords: ['safety', 'sécurité', 'hygiene'], priority: 2 },
      { keywords: ['social', 'relationship', 'friend'], priority: 2 }
    ]
  };
