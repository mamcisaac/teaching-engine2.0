    ...
    for (const lessonData of lessons) {
      const lesson = await prisma.eTFOLessonPlan.create({
        data: {
          ...
          learningGoals: `Students will deepen number understanding to 20 and beyond. French connection: French language integration`,
          learningGoalsFr: `Les élèves approfondiront la compréhension des nombres jusqu'à 20 et plus. French language integration`,
