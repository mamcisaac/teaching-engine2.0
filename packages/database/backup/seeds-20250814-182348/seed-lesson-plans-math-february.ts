    ...
    for (const lessonData of lessons) {
      const lesson = await prisma.eTFOLessonPlan.create({
        data: {
          ...
          learningGoals: `Students will develop mental math strategies and understand equality as balance. French language integration`,
          learningGoalsFr: `Les élèves développeront des stratégies de calcul mental et comprendront l'égalité comme équilibre. French language integration`,
