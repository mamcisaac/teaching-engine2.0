    ...
    for (const lessonData of lessons) {
      const lesson = await prisma.eTFOLessonPlan.create({
        data: {
          ...
          learningGoals: `Students will demonstrate advanced problem-solving skills and mathematical reasoning. French language integration`,
          learningGoalsFr: `Les élèves démontreront compétences avancées résolution problèmes et raisonnement mathématique. French language integration`,
