    ...
    for (const lessonData of lessons) {
      const lesson = await prisma.eTFOLessonPlan.create({
        data: {
          ...
          learningGoals: `Students will celebrate mathematical growth and reflect on their learning journey. French language integration`,
          learningGoalsFr: `Les élèves célébreront leur croissance mathématique et réfléchiront sur leur parcours d'apprentissage. French language integration`,
