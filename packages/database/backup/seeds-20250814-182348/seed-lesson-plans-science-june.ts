    ...
    for (const lessonData of lessons) {
      const lesson = await prisma.eTFOLessonPlan.create({
        data: {
          ...
          learningGoals: `Students will complete their environmental stewardship learning and celebrate a year of scientific discovery. French language integration`,
          learningGoalsFr: `Les élèves complèteront apprentissage intendance environnementale et célébreront année découverte scientifique. French language integration`,
