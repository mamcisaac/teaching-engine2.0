    ...
    for (const lessonData of lessons) {
      const lesson = await prisma.eTFOLessonPlan.create({
        data: {
          ...
          learningGoals: `Students will apply mathematical knowledge and strategies to solve real-world problems. French language integration`,
          learningGoalsFr: `Les élèves appliqueront connaissances et stratégies mathématiques pour résoudre problèmes monde réel. French language integration`,
