...
async function seedArtsMarchLessonPlans() {
  ...
  try {
    ...
    lessons.push({
      ...
      vocabulary: ['courtepointe', 'carré', 'assembler', 'collaborer', 'unifier', 'traditionnel', 'célébrer', 'ensemble'],
    ...
    lessons.push({
      ...
      vocabulary: ['mathématiques', 'règle', 'comptage', 'géométrique', 'progression', 'analyser', 'expliquer', 'musée'],
    ...
    lessons.push({
      ...
      vocabulary: ['raconter', 'histoire', 'image', 'communiquer', 'émotion', 'début', 'fin', 'séquence'],
    ...
    lessons.push({
      ...
      vocabulary: ['personnage', 'personnalité', 'caractéristique', 'détail', 'visuel', 'concevoir', 'original', 'audition'],
    ...
    lessons.push({
      ...
      vocabulary: ['printemps', 'renouveau', 'croissance', 'fleurir', 'pousser', 'bébé', 'animal', 'festival'],
    ...
    lessons.push({
      ...
      vocabulary: ['Pâques', 'célébration', 'tradition', 'famille', 'communauté', 'partager', 'personnel', 'culture'],
    ...
    lessons.push({
      ...
      vocabulary: ['émotion', 'expression', 'faciale', 'corporel', 'langage', 'miroir', 'théâtre', 'jouer'],
    ...
    lessons.push({
      ...
      vocabulary: ['vie', 'personnel', 'autobiographique', 'mémoire', 'souvenir', 'événement', 'important', 'spécial'],
