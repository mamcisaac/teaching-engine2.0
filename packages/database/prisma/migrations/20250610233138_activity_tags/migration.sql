...
INSERT INTO "new_Activity" ("activityType", "completedAt", "durationMins", "id", "milestoneId", "orderIndex", "privateNote", "publicNote", "title", "userId") SELECT "activityType", "completedAt", "durationMins", "id", "milestoneId", "orderIndex", "privateNote", "publicNote", "title", "userId" FROM "Activity";
DROP TABLE "Activity";
