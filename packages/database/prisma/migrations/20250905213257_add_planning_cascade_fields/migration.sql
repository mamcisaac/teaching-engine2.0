...
INSERT INTO "new_StudentAssessment" ("createdAt", "date", "expectationId", "id", "lessonId", "level", "notes", "studentId", "subject", "title", "updatedAt", "userId") SELECT "createdAt", "date", "expectationId", "id", "lessonId", "level", "notes", "studentId", "subject", "title", "updatedAt", "userId" FROM "StudentAssessment";
