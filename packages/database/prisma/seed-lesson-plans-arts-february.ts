...
async function seedArtsFebruaryLessonPlans() {
  ...
  try {
    ...
    lessons.push({
      ...
      vocabulary: ['texture', 'lisse', 'rugueux', 'doux', 'dur', 'frottage', 'toucher', 'sentir'],
    ...
    lessons.push({
      ...
      vocabulary: ['motif', 'répéter', 'modèle', 'séquence', 'continuer', 'prévoir', 'régulier', 'ordre'],
    ...
    lessons.push({
      ...
      vocabulary: ['nature', 'coquille', 'feuille', 'écorce', 'roche', 'empreinte', 'estampe', 'beauté'],
    ...
    lessons.push({
      ...
      vocabulary: ['textile', 'tissu', 'tisser', 'trame', 'chaîne', 'matériau', 'fibre', 'défilé'],
    ...
    lessons.push({
      ...
      vocabulary: ['impression', 'imprimer', 'encre', 'rouleau', 'pression', 'série', 'technique', 'studio'],
    ...
    lessons.push({
      ...
      vocabulary: ['culture', 'mondial', 'tradition', 'origine', 'géométrique', 'inspiration', 'respecter', 'apprécier'],
    ...
    lessons.push({
      ...
      vocabulary: ['médias mixtes', 'combiner', 'superposer', 'profondeur', 'effet', 'complexe', 'critique', 'décrire'],
    ...
    lessons.push({
      ...
      vocabulary: ['conception', 'original', 'appliquer', 'fonctionnel', 'choix', 'expliquer', 'présenter', 'personnel'],
