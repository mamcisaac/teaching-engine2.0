    ...
    for (const lessonData of lessons) {
      const lesson = await prisma.eTFOLessonPlan.create({
        data: {
          ...
          learningGoals: `Students will explore environmental connections and human impact on nature. ${lessonData.frenchConnection}`,
          learningGoalsFr: `Les élèves exploreront connexions environnementales et impact humain sur nature. ${lessonData.frenchConnection}`,
