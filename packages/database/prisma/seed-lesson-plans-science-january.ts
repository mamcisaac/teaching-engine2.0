    ...
    for (const lessonData of lessons) {
      const lesson = await prisma.eTFOLessonPlan.create({
        data: {
          ...
          learningGoals: `Students will explore winter science concepts through direct observation and experimentation. ${lessonData.frenchConnection}`,
          learningGoalsFr: `Les élèves exploreront les concepts scientifiques d'hiver par observation et expérimentation. ${lessonData.frenchConnection}`,
