    ...
    for (const lessonData of lessons) {
      const lesson = await prisma.eTFOLessonPlan.create({
        data: {
          ...
          learningGoals: `Students will explore measurement concepts through hands-on investigation and comparison. ${lessonData.frenchConnection}`,
          learningGoalsFr: `Les élèves exploreront les concepts de mesure par investigation pratique et comparaison. ${lessonData.frenchConnection}`,
          ...
          differentiationStrategies: JSON.stringify({
            ...
            vocabulary: 'Rich measurement vocabulary development',
          ...
          crossCurricularConnections: `${lessonData.frenchConnection}. Science: measuring plant growth, exploring weight and capacity. Social Studies: time in daily life, money in community. Arts: measuring for craft projects.`,
          
          // Pedagogical approach
          pedagogicalApproach: 'Hands-on exploration, comparison before measuring, real-world contexts, mathematical vocabulary development',
          
          timeOfDay: '9:45 AM - 10:30 AM',
          
          // Special unit features
          specialFocus: 'Measurement sense development, comparison skills, French measurement vocabulary, real-world applications'
        }
      });
