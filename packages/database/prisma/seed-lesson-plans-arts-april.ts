...
async function seedArtsAprilLessonPlans() {
  ...
  try {
    ...
    lessons.push({
      ...
      vocabulary: ['bande dessinée', 'panneau', 'séquentiel', 'dialogue', 'bulle', 'personnage', 'publier', 'collection'],
    ...
    lessons.push({
      ...
      vocabulary: ['conte', 'populaire', 'traditionnel', 'scène', 'décor', 'détail', 'galerie', 'représenter'],
    ...
    lessons.push({
      ...
      vocabulary: ['communauté', 'aide', 'société', 'rôle', 'action', 'problème', 'solution', 'appréciation'],
    ...
    lessons.push({
      ...
      vocabulary: ['environnement', 'protection', 'nature', 'planète', 'soin', 'engagement', 'Terre', 'exposition'],
    ...
    lessons.push({
      ...
      vocabulary: ['jardin', 'croissance', 'graine', 'pousse', 'semis', 'fleur', 'série', 'incroyable'],
    ...
    lessons.push({
      ...
      vocabulary: ['famille', 'animal', 'bébé', 'parent', 'prendre soin', 'enseigner', 'jeune', 'narration'],
    ...
    lessons.push({
      ...
      vocabulary: ['rêve', 'imagination', 'fantastique', 'magique', 'élément', 'esprit', 'atmosphère', 'imaginatif'],
    ...
    lessons.push({
      ...
      vocabulary: ['collaboration', 'contribuer', 'individuel', 'partager', 'combiner', 'murale', 'équipe', 'dévoiler'],
