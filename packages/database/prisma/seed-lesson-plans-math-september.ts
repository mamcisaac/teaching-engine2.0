    ...
    for (const lessonData of lessons) {
      const lesson = await prisma.eTFOLessonPlan.create({
        data: {
          ...
          learningGoals: `Students will develop number sense and mathematical thinking skills. ${lessonData.frenchConnection}`,
          learningGoalsFr: `Les élèves développeront le sens du nombre et les compétences mathématiques. ${lessonData.frenchConnection}`,
