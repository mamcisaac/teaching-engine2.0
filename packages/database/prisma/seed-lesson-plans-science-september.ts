    ...
    for (const lessonData of lessons) {
      const lesson = await prisma.eTFOLessonPlan.create({
        data: {
          ...
          learningGoals: `Students will develop scientific observation and inquiry skills. ${lessonData.frenchConnection}`,
          learningGoalsFr: `Les élèves développeront l'observation scientifique et l'enquête. ${lessonData.frenchConnection}`,
