  ...
  try {
    ...
    const septLessons = [
      {
        ...
        curriculumExpectations: 'CC 1.1, ME 1 - Create music using voice and body, demonstrate elements through play'
      },
      {
        ...
        curriculumExpectations: 'CC 1.1, ME 1 - Create music using body, explore musical elements'
      },
      {
        ...
        curriculumExpectations: 'ME 1, MA 1.1 - Demonstrate musical elements, proper percussion technique'
      },
      {
        ...
        curriculumExpectations: 'MA 1.2, CC 1.1 - Demonstrate voice in various contexts through musical play'
      },
      {
        ...
        curriculumExpectations: 'MA 1.2, SP 1 - Demonstrate voice variety, perform for audiences'
      }
    ];
    ...
    const octLessons = [
      {
        ...
        curriculumExpectations: 'ME 1, MA 1.2 - Demonstrate musical elements, voice in various contexts'
      },
      {
        ...
        curriculumExpectations: 'CC 1.1, ME 1, MA 1.1 - Create music with instruments, demonstrate elements'
      },
      {
        ...
        curriculumExpectations: 'MA 1.1, CC 1.1 - Proper percussion technique, create music with instruments'
      },
      {
        ...
        curriculumExpectations: 'ME 1, CCC 1 - Demonstrate elements through movement, understand diverse musical styles'
      },
      {
        ...
        curriculumExpectations: 'ME 1, MA 1.1, MA 1.2 - Demonstrate tempo, instrument technique, voice variety'
      },
      {
        ...
        curriculumExpectations: 'CC 1.1, SP 1, CCC 1 - Create music creatively, perform for audiences, cultural contexts'
      }
    ];
    ...
    const novLessons = [
      {
        ...
        curriculumExpectations: 'ME 1, MA 1.1, MA 1.2 - Demonstrate dynamics, instrument control, voice variety'
      },
      {
        ...
        curriculumExpectations: 'MA 1.1, SP 1, CC 1.1 - Percussion technique, perform for audiences, create music together'
      },
      {
        ...
        curriculumExpectations: 'MA 1.2, SP 1, CCC 1 - Voice demonstration, performance, cultural contexts'
      },
      {
        ...
        curriculumExpectations: 'CCC 1, MA 1.2, SP 1 - Cultural contexts, voice variety, respectful performance'
      },
      {
        ...
        curriculumExpectations: 'MA 1.2, CCC 1, CC 1.1 - Voice in contexts, cultural understanding, creative expression'
      },
      {
        ...
        curriculumExpectations: 'MA 1.2, ME 1, CC 1.1 - Voice expression, musical elements, creative music making'
      }
    ];
    ...
    const decLessons = [
      {
        ...
        curriculumExpectations: 'CCC 1, MA 1.2, SP 1 - Cultural contexts, voice variety, performance'
      },
      {
        ...
        curriculumExpectations: 'CC 1.1, CC 1.2, ME 1 - Create music, compose ideas, demonstrate elements'
      },
      {
        ...
        curriculumExpectations: 'CC 1.2, CC 1.1 - Compose using notations, create musical ideas'
      },
      {
      ...
      },
      {
        ...
        curriculumExpectations: 'RRA 1, SP 1 - Refine performances using creative process, perform for audiences'
      },
      {
        ...
        curriculumExpectations: 'CCC 1, SP 1, MA 1.2 - Cultural contexts, performance, voice in various contexts'
      }
    ];
    ...
    const janLessons = [
      {
        ...
        curriculumExpectations: 'CCC 1, RRA 1 - Cultural contexts, refining musical process'
      },
      {
        ...
        curriculumExpectations: 'CC 1.1, CC 1.2 - Create music through play, compose using notations'
      },
      {
        ...
        curriculumExpectations: 'CC 1.1, CC 1.2, SP 1 - Create music together, compose ideas, perform'
      },
      {
        title: 'Sound Stories',
        ...
        curriculumExpectations: 'CC 1.1, CC 1.2, MA 1.1 - Create music, compose ideas, instrument technique'
      },
      {
        ...
        curriculumExpectations: 'CC 1.2, ME 1 - Compose using patterns, demonstrate musical elements'
      },
      {
        ...
        curriculumExpectations: 'CC 1.2, CC 1.1 - Compose using technology, create music creatively'
      },
      {
        ...
        curriculumExpectations: 'MA 1.1, CCC 1 - Instrument techniques, diverse musical contexts'
      },
      {
        ...
        curriculumExpectations: 'CC 1.1, MA 1.2, SP 1 - Create music communicatively, voice variety, performance'
      }
    ];
    ...
    const febLessons = [
      ...
      },
      {
        ...
        curriculumExpectations: 'CCC 1, MA 1.2, SP 1 - Cultural contexts, voice in contexts, performance'
      },
      {
        ...
        curriculumExpectations: 'CC 1.1, CC 1.2, MA 1.1 - Create music, compose ideas, percussion technique'
      },
      {
        ...
        curriculumExpectations: 'CC 1.1, SP 1, ME 1 - Create integrated music, perform, demonstrate elements'
      },
      {
        ...
        curriculumExpectations: 'ME 1, CC 1.2, RRA 1 - Demonstrate musical elements, compose solutions, refine process'
      },
      {
        ...
        curriculumExpectations: 'SP 1, CCC 1 - Performance for audiences, cultural contexts and connections'
      }
    ];
    ...
    const marLessons = [
      {
        ...
        curriculumExpectations: 'CCC 1, MA 1.1, MA 1.2 - Cultural contexts, percussion technique, voice variety'
      },
      {
        ...
        curriculumExpectations: 'CCC 1, ME 1, SP 1 - Cultural understanding, musical elements, performance'
      },
      {
        ...
        curriculumExpectations: 'CCC 1, MA 1.2, SP 1 - Cultural contexts, voice performance, audience performance'
      },
      {
        ...
        curriculumExpectations: 'CCC 1, MA 1.1, ME 1 - Cultural contexts, percussion technique, musical elements'
      },
      {
        ...
        curriculumExpectations: 'CCC 1, ME 1 - Cultural understanding, musical elements exploration'
      },
      {
        ...
        curriculumExpectations: 'CCC 1, MA 1.2 - Cultural contexts, voice in various cultural contexts'
      },
      {
        ...
        curriculumExpectations: 'SP 1, CCC 1, RRA 1 - Performance preparation, cultural contexts, refining process'
      }
    ];
    ...
    const aprLessons = [
      {
        ...
        curriculumExpectations: 'SP 1, CCC 1 - Performance for diverse audiences, cultural contexts and connections'
      },
      {
      ...
      },
      {
        ...
        curriculumExpectations: 'RRA 1, SP 1 - Refine using creative process, perform growth demonstrations'
      },
      {
        ...
        curriculumExpectations: 'CC 1.1, CC 1.2, SP 1 - Create music together, compose collaboratively, perform'
      },
      {
        ...
        curriculumExpectations: 'CCC 1, SP 1, MA 1.2 - Cultural contexts, performance, voice in cultural contexts'
      },
      {
        ...
        curriculumExpectations: 'CC 1.2, SP 1 - Compose using technology, perform digital creations'
      }
    ];
    ...
    const mayLessons = [
      {
        ...
        curriculumExpectations: 'SP 1, RRA 1, MA 1.2 - Perform for audiences, refine performances, voice demonstration'
      },
      {
        ...
        curriculumExpectations: 'SP 1, MA 1.2, CC 1.1 - Performance leadership, voice variety, create music with others'
      },
      {
        ...
        curriculumExpectations: 'SP 1, CCC 1 - Perform for diverse audiences, understand music\'s community connections'
      },
      {
        ...
        curriculumExpectations: 'CC 1.1, CC 1.2, RRA 1 - Creative music-making, composition, refine creative process'
      },
      {
        ...
        curriculumExpectations: 'CC 1.1, ME 1, SP 1 - Create music through play, demonstrate elements, perform/teach others'
      },
      {
        ...
        curriculumExpectations: 'CCC 1, SP 1, MA 1.2 - Cultural contexts and connections, inclusive performance, voice variety'
      }
    ];
    ...
    const junLessons = [
      {
        ...
        curriculumExpectations: 'SP 1, RRA 1 - Perform for audiences, demonstrate refined musical process'
      },
      {
        ...
        curriculumExpectations: 'RRA 1, CC 1.2 - Reflect on musical process, creative documentation'
      },
      {
        ...
        curriculumExpectations: 'CC 1.1, SP 1 - Create meaningful music, perform as gifts'
      },
      {
        ...
        curriculumExpectations: 'RRA 1 - Plan continued musical process and growth'
      }
    ];
