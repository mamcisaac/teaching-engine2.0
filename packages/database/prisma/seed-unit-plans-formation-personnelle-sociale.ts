  ...
  try {
    ...
    const unit1 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'French: personal narratives; Arts: self-portraits; Science: human body; PE: body awareness',
    ...
    const unit2 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'Science: human body, nutrition; PE: physical activity, fitness; Math: daily routine schedules; French: health vocabulary',
    ...
    const unit3 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'Social Studies: community helpers; Science: weather safety; PE: playground safety; Math: emergency numbers',
    ...
    const unit4 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'French: feeling vocabulary, social stories; Drama: role play; Arts: emotion art; PE: teamwork',
    ...
    const unit5 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'All subjects: reflection on learning; Math: measuring growth; French: growth narratives; Science: life cycles',
    ...
    const unit6 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'Social Studies: community; Science: summer safety; PE: summer activities; Arts: community celebration',
