    ...
    for (const lessonData of lessons) {
      const lesson = await prisma.eTFOLessonPlan.create({
        data: {
          ...
          learningGoals: `Students will explore energy concepts through hands-on investigations. ${lessonData.frenchConnection}`,
          learningGoalsFr: `Les élèves exploreront les concepts d'énergie par investigations. ${lessonData.frenchConnection}`,
