    ...
    for (const lessonData of lessons) {
      const lesson = await prisma.eTFOLessonPlan.create({
        data: {
          ...
          learningGoals: `Students will develop addition and subtraction strategies and fluency to 20. ${lessonData.frenchConnection}`,
          learningGoalsFr: `Les élèves développeront des stratégies d'addition et soustraction jusqu'à 20. ${lessonData.frenchConnection}`,
          ...
          crossCurricularConnections: `${lessonData.frenchConnection}. Indigenous connections: Traditional counting methods, sharing circles. Environmental: Conservation math problems.`,
          
          // Additional metadata
          pedagogicalApproach: 'Concrete-Pictorial-Abstract progression, Number Talk routines, Problem-solving focus',
