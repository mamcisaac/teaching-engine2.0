    ...
    for (const lessonData of lessons) {
      const lesson = await prisma.eTFOLessonPlan.create({
        data: {
          ...
          learningGoals: `Students will investigate growth and life cycles through hands-on exploration and observation. ${lessonData.frenchConnection}`,
          learningGoalsFr: `Les élèves investigueront croissance et cycles de vie par exploration et observation. ${lessonData.frenchConnection}`,
