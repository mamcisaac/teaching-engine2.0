...
async function seedArtsOctoberExtendedLessonPlans() {
  ...
  try {
    ...
    lessons.push({
      ...
      vocabulary: ['cercle chromatique', 'primaire', 'secondaire', 'mélanger', 'relation', 'découvrir', 'observation', 'magie'],
    ...
    lessons.push({
      ...
      vocabulary: ['festival', 'célébration', 'tradition', 'récolte', 'festif', 'décoration', 'inclusif', 'diversité'],
