    ...
    for (const lessonData of lessons) {
      const lesson = await prisma.eTFOLessonPlan.create({
        data: {
          ...
          learningGoals: `Students will complete winter science investigations and synthesize winter learning. ${lessonData.frenchConnection}`,
          learningGoalsFr: `Les élèves complèteront investigations sciences hiver et synthétiseront apprentissage. ${lessonData.frenchConnection}`,
