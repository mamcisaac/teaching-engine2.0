...
async function seedArtsDecemberLessonPlans() {
  ...
  try {
    ...
    lessons.push({
      ...
      vocabulary: ['hiver', 'neige', 'glace', 'froid', 'blanc', 'texture', 'doux', 'brillant'],
    ...
    lessons.push({
      ...
      vocabulary: ['célébration', 'tradition', 'culture', 'symbole', 'fête', 'famille', 'communauté', 'partager'],
    ...
    lessons.push({
      ...
      vocabulary: ['lumière', 'ombre', 'briller', 'éclat', 'sombre', 'clair', 'lanterne', 'magique'],
    ...
    lessons.push({
      ...
      vocabulary: ['cadeau', 'donner', 'créer', 'amour', 'soin', 'pensée', 'famille', 'ami'],
    ...
    lessons.push({
      ...
      vocabulary: ['flocon', 'cristal', 'symétrie', 'motif', 'géométrie', 'unique', 'plier', 'découper'],
    ...
    lessons.push({
      ...
      vocabulary: ['portfolio', 'réflexion', 'croissance', 'apprendre', 'fier', 'progrès', 'artiste', 'célébrer'],
