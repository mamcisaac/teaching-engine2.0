    ...
    for (const lessonData of lessons) {
      const lesson = await prisma.eTFOLessonPlan.create({
        data: {
          ...
          learningGoals: `Students will explore artistic expression and creativity. ${lessonData.frenchConnection}`,
          learningGoalsFr: `Les élèves exploreront l'expression artistique et la créativité. ${lessonData.frenchConnection}`,
