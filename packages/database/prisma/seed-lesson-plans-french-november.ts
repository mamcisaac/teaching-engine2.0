...
async function seedFrenchNovemberLessons() {
  ...
  try {
    ...
    lessons.push({
      ...
      subject: 'Français langue première',
      duration: 60,
      primaryFocus: 'Expressing gratitude in French: merci, reconnaissance, gratitude',
      learningGoals: 'Students will express what they are thankful for using French vocabulary and simple sentences.',
      vocabulary: ['merci', 'gratitude', 'reconnaissance', 'remercier', 'content', 'heureux'],
      ...
      groupingStrategies: 'Whole class discussion, individual creation, partner sharing',
    ...
    lessons.push({
      ...
      subject: 'Français langue première',
      duration: 60,
      primaryFocus: 'Learning harvest vocabulary: récolte, citrouille, pomme, maïs',
      learningGoals: 'Students will identify and use autumn harvest vocabulary in French contexts.',
      vocabulary: ['récolte', 'citrouille', 'pomme', 'maïs', 'feuille', 'arbre'],
      ...
      groupingStrategies: 'Whole class, small groups, pairs',
    ...
    lessons.push({
      ...
      subject: 'Français langue première',
      duration: 60,
      primaryFocus: 'Describing November weather: froid, nuageux, venteux, pluvieux',
      learningGoals: 'Students will describe daily weather using French weather vocabulary and expressions.',
      vocabulary: ['froid', 'nuageux', 'venteux', 'pluvieux', 'brumeux', 'température'],
      ...
      groupingStrategies: 'Whole class, partners, individual work',
    ...
    lessons.push({
      ...
      subject: 'Français langue première',
      duration: 60,
      primaryFocus: 'Learning Remembrance Day vocabulary: souvenir, paix, coquelicot',
      learningGoals: 'Students will understand Remembrance Day significance and learn related French vocabulary.',
      vocabulary: ['souvenir', 'paix', 'coquelicot', 'remercier', 'héros', 'courage'],
      ...
      groupingStrategies: 'Whole class discussion, individual creation, sharing circle',
    ...
    lessons.push({
      ...
      subject: 'Français langue première',
      duration: 60,
      primaryFocus: 'Exploring peace and kindness vocabulary: paix, gentillesse, amitié',
      learningGoals: 'Students will express ideas about peace and kindness using French vocabulary.',
      vocabulary: ['paix', 'gentillesse', 'amitié', 'partager', 'aider', 'ensemble'],
      ...
      groupingStrategies: 'Circle time, small groups, whole class',
    ...
    lessons.push({
      ...
      subject: 'Français langue première',
      duration: 60,
      primaryFocus: 'Learning community helper vocabulary: pompier, policier, médecin, enseignant',
      learningGoals: 'Students will identify community helpers and describe their roles in French.',
      vocabulary: ['pompier', 'policier', 'médecin', 'enseignant', 'infirmier', 'aider'],
      ...
      groupingStrategies: 'Whole class game, partners, individual work',
    ...
    lessons.push({
      ...
      subject: 'Français langue première',
      duration: 60,
      primaryFocus: 'Winter preparation vocabulary: hiver, neige, froid, manteau',
      learningGoals: 'Students will discuss winter preparations using French winter vocabulary.',
      vocabulary: ['hiver', 'neige', 'froid', 'manteau', 'mitaines', 'écharpe'],
      ...
      groupingStrategies: 'Teams for relay, individual design, whole class show',
    ...
    lessons.push({
      ...
      subject: 'Français langue première',
      duration: 60,
      primaryFocus: 'Learning about animals in winter: hiberner, migrer, s\'adapter',
      learningGoals: 'Students will describe how animals prepare for winter using French vocabulary.',
      vocabulary: ['hiberner', 'migrer', 's\'adapter', 'ours', 'écureuil', 'oiseau'],
      ...
      groupingStrategies: 'Whole class game, individual books, presentation pairs',
    ...
    lessons.push({
      ...
      subject: 'Français langue première',
      duration: 60,
      primaryFocus: 'Winter activity vocabulary: patiner, glisser, jouer, construire',
      learningGoals: 'Students will describe winter activities they enjoy using French action words.',
      vocabulary: ['patiner', 'glisser', 'jouer', 'construire', 'bonhomme de neige', 'plaisir'],
      ...
      groupingStrategies: 'Whole class game, individual collages, partner sharing',
    ...
    lessons.push({
      ...
      subject: 'Français langue première',
      duration: 60,
      primaryFocus: 'Learning celebration vocabulary: fête, célébrer, tradition, famille',
      learningGoals: 'Students will explore different celebrations and learn related French vocabulary.',
      vocabulary: ['fête', 'célébrer', 'tradition', 'famille', 'lumière', 'joie'],
      ...
      groupingStrategies: 'Whole class game, small groups, individual sharing',
    ...
    lessons.push({
      ...
      subject: 'Français langue première',
      duration: 60,
      primaryFocus: 'Exploring light vocabulary: lumière, bougie, étoile, briller',
      learningGoals: 'Students will describe different sources of light and their importance in French.',
      vocabulary: ['lumière', 'bougie', 'étoile', 'briller', 'éclairer', 'chaleur'],
      ...
      groupingStrategies: 'Exploration pairs, individual crafts, circle sharing',
    ...
    lessons.push({
      ...
      subject: 'Français langue première',
      duration: 60,
      primaryFocus: 'Gift-giving vocabulary: cadeau, donner, partager, générosité',
      learningGoals: 'Students will express ideas about giving and sharing using French vocabulary.',
      vocabulary: ['cadeau', 'donner', 'partager', 'générosité', 'gentil', 'ami'],
      ...
      groupingStrategies: 'Circle activity, individual creation, partner exchange',
