...
/**
 * Comprehensive Grade 1 French Immersion Curriculum Seed
 * Populates database with PEI-specific curriculum expectations
 */
...
const databaseUrl = process.env.DATABASE_URL ?? 
  `file:${path.resolve(process.cwd(), 'packages/database/prisma/dev.db')}`;
...
async function seedGrade1Curriculum() {
  ...
  try {
    ...
    // 9. FORMATION PERSONNELLE ET SOCIALE (in French)
    console.log('🍎 Creating Formation personnelle et sociale expectations...');
    const health = [
      { code: 'FPS1.1', description: 'Identifier les habitudes de vie saines', strand: 'Santé personnelle', substrand: 'Habitudes' },
      { code: 'FPS1.2', description: 'Reconnaître l\'importance de l\'hygiène personnelle', strand: 'Santé personnelle', substrand: 'Hygiène' },
      { code: 'FPS1.3', description: 'Identifier les émotions de base', strand: 'Santé mentale', substrand: 'Émotions' },
      { code: 'FPS1.4', description: 'Pratiquer des stratégies de gestion du stress', strand: 'Santé mentale', substrand: 'Bien-être' },
      { code: 'FPS1.5', description: 'Comprendre la sécurité personnelle', strand: 'Sécurité', substrand: 'Protection personnelle' }
    ];
