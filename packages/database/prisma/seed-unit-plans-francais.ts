  ...
  try {
    ...
    const unit1 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'Math: counting syllables; Arts: drawing self-portraits with name labels; Social Studies: classroom community',
    ...
    const unit2 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'Math: counting family members, comparing sizes; Art: family portraits; Social Studies: diverse family structures',
    ...
    const unit3 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'Science: seasonal changes, harvest; Math: calendar, patterns in nature; Arts: seasonal crafts',
    ...
    const unit4 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'Science: water/ice/snow, weather; Math: temperature, measuring snow; PE: winter activities',
    ...
    const unit5 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'Science: animal needs and habitats; Math: sorting and classifying; Arts: animal art and movement',
        learningSkills: JSON.stringify(['Initiative', 'Independent work', 'Collaboration']),
    ...
    const unit6 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'Social Studies: community mapping, jobs; Math: directions, addresses; Health: safety helpers',
    ...
    const unit7 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'Science: plant growth, life cycles; Math: measurement, graphing growth; Arts: spring colors and poetry',
    ...
    const unit8 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'All subjects: year review and integration, memory books, celebration planning',
