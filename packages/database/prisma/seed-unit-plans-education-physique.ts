  ...
  try {
    ...
    const unit1 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'Health: body systems, nutrition; Science: human body, senses; French: body parts vocabulary; Math: counting, patterns',
    ...
    const unit2 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'Math: spatial concepts, patterns, directions; Science: force and motion, balance; Art: creative movement',
    ...
    const unit3 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'Math: shapes, sizes, counting; Science: force, motion, gravity; Art: creative object use; French: object vocabulary',
    ...
    const unit4 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'Arts: creative expression, rhythm; Social Studies: cooperation, community; Music: movement to rhythm; Drama: expression',
    ...
    const unit5 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'Math: strategy, problem-solving; Social Studies: fair play, rules; Health: safety, respect; French: game vocabulary',
    ...
    const unit6 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'Health: nutrition, sleep, hygiene; Science: body systems, heart, muscles; Math: tracking, measuring; Social Studies: community health',
    ...
    const unit7 = await prisma.unitPlan.create({
      data: {
        ...
        crossCurricularConnections: 'All subjects: year-end integration; Arts: movement expression; Health: lifelong activity; French: reflection vocabulary',
