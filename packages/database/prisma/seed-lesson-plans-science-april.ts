    ...
    for (const lessonData of lessons) {
      const lesson = await prisma.eTFOLessonPlan.create({
        data: {
          ...
          learningGoals: `Students will observe and document seasonal changes from winter through spring. ${lessonData.frenchConnection}`,
          learningGoalsFr: `Les élèves observeront et documenteront changements saisonniers hiver au printemps. ${lessonData.frenchConnection}`,
