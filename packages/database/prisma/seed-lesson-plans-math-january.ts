    ...
    for (const lessonData of lessons) {
      const lesson = await prisma.eTFOLessonPlan.create({
        data: {
          ...
          learningGoals: `Students will develop fluency and strategic thinking in addition/subtraction to 20. ${lessonData.frenchConnection}`,
          learningGoalsFr: `Les élèves développeront l'aisance et la pensée stratégique en addition/soustraction jusqu'à 20. ${lessonData.frenchConnection}`,
          ...
          crossCurricularConnections: `${lessonData.frenchConnection}. Science connections: data collection and analysis. Social Studies: community helpers and math in jobs. Arts: geometric art and patterns.`,
          
          // Pedagogical emphasis
          pedagogicalApproach: 'Number talks daily, strategy sharing emphasis, student choice in methods, assessment as learning',
          
          timeOfDay: '9:45 AM - 10:30 AM',
          
          // Unit culmination indicators
          unitPhase: lessonCount >= 15 ? 'culmination' : 'development'
        }
      });
