...
async function seedFrenchOctoberLessonPlans() {
  ...
  try {
    ...
    lessons.push({
      ...
      primaryFocus: 'French family vocabulary: maman, papa, frère, sœur',
      mathConnection: 'Count family members',
      vocabulary: ['famille', 'maman', 'papa', 'frère', 'sœur']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Extended family vocabulary and descriptions',
      vocabulary: ['grand-mère', 'grand-père', 'tante', 'oncle', 'cousin']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Family activity vocabulary',
      vocabulary: ['jouer', 'manger', 'lire', 'ensemble']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Home vocabulary in French',
      vocabulary: ['maison', 'chambre', 'cuisine', 'salon']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Tradition and celebration vocabulary',
      vocabulary: ['tradition', 'fête', 'célébrer', 'spécial']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Pet vocabulary and descriptions',
      scienceConnection: 'Animal needs and care',
      vocabulary: ['animal', 'chien', 'chat', 'poisson']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Food and mealtime vocabulary',
      vocabulary: ['manger', 'déjeuner', 'dîner', 'souper']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Narrative vocabulary and story structure',
      vocabulary: ['histoire', 'raconter', 'drôle', 'aventure']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Gratitude and appreciation vocabulary',
      vocabulary: ['merci', 'aimer', 'apprécier', 'reconnaissance']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Helping and cooperation vocabulary',
      vocabulary: ['aider', 'partager', 'nettoyer', 'ranger']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Play and entertainment vocabulary',
      vocabulary: ['jouer', 'rire', 'amusant', 'gagner']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Emotion vocabulary in family context',
      vocabulary: ['content', 'triste', 'fâché', 'fier']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Growth and change vocabulary',
      mathConnection: 'Measuring growth, comparing sizes',
      vocabulary: ['grandir', 'bébé', 'maintenant', 'grand']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Job and career vocabulary',
      vocabulary: ['travail', 'métier', 'docteur', 'professeur']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Transportation vocabulary',
      vocabulary: ['voiture', 'autobus', 'marcher', 'voyage']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Seasonal vocabulary with family activities',
      scienceConnection: 'Autumn changes observation',
      vocabulary: ['automne', 'hiver', 'printemps', 'été']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Music and song vocabulary',
      vocabulary: ['chanson', 'musique', 'chanter', 'danser']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Costume and Halloween vocabulary',
      vocabulary: ['costume', 'Halloween', 'sorcière', 'fantôme']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Celebration and party vocabulary',
      vocabulary: ['fête', 'gâteau', 'cadeau', 'célébrer']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Hero and admiration vocabulary',
      vocabulary: ['héros', 'brave', 'fort', 'gentil']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Memory and past tense vocabulary',
      vocabulary: ['souvenir', 'rappeler', 'avant', 'photo']
    });
    ...
    lessons.push({
      ...
      primaryFocus: 'Review all October family vocabulary',
      vocabulary: ['famille', 'célébrer', 'ensemble', 'Halloween']
    });
    ...
    for (const lessonData of lessons) {
      const lesson = await prisma.eTFOLessonPlan.create({
        data: {
          ...
          learningGoals: `PRIMARY FOCUS: ${lessonData.primaryFocus}. Students will develop French vocabulary and communication skills in family contexts.${lessonData.mathConnection ? ` Natural connection: ${lessonData.mathConnection}` : ''}${lessonData.scienceConnection ? ` Natural connection: ${lessonData.scienceConnection}` : ''}`,
          learningGoalsFr: `FOCUS PRINCIPAL: ${lessonData.primaryFocus}. Les élèves développeront le vocabulaire et la communication en contextes familiaux.`,
          ...
          assessmentNotes: `Focus on French vocabulary acquisition and use. Document: vocabulary use (${lessonData.vocabulary.join(', ')}), pronunciation attempts, comprehension, participation in French.`,
      ...
      console.log(`   Primary: ${lessonData.primaryFocus}`);
      console.log(`   Vocabulary: ${lessonData.vocabulary.join(', ')}`);
