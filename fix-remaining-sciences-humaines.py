#!/usr/bin/env python3
"""
Fix remaining template materials in sciences-humaines files that had JSON errors
"""
import json
import sys
...
def get_materials_for_activity(activity_description):
    ...
    # Family-related activities (for family unit)
    elif 'family' in activity or 'famille' in activity or 'parents' in activity or 'home' in activity:
        return {
            "required": [{
                "item": "Photos de familles diverses et inclusives",
                "quantity": "15-20 photos montrant différents types de familles",
                "preparation": "Sélectionner images représentant familles monoparentales, élargies, adoptives, etc.",
                "alternatives": [
                    "Dessins de différentes structures familiales",
                    "Marionnettes représentant membres famille",
                    "Livres d'images sur diversité familiale"
                ]
            }],
            "optional": [{
                "item": "Matériel pour arbre généalogique simple",
                "quantity": "25 feuilles pré-dessinées + photos famille",
                "purpose": "Pour créer représentation visuelle simple de leur famille"
            }]
        }
    ...
    # Default for other activities
        ...
        return {
            "required": [{
                "item": "Matériel d'exploration communautaire adapté",
                "quantity": "Matériel spécifique à l'activité décrite",
                "preparation": "Préparer selon les besoins de l'activité particulière",
                "alternatives": [
            ...
            "optional": [{
                "item": "Support d'enrichissement contextuel",
                "quantity": "Selon les besoins et disponibilité",
                "purpose": "Pour approfondir l'exploration du concept abordé"
            }]
        }
...
# Process the three files that had issues
remaining_files = [
...
print(f"\n🎉 ADDITIONAL FIXED: {total_fixed} template material sections")
print("Remaining sciences-humaines files processed!")