...
Call log:
  - waiting for locator('input[type="date"]')
    - locator resolved to <input value="" type="date" class="border p-1"/>
    - fill("2025-12-25")
  - attempting fill action
    - waiting for element to be visible, enabled and editable
  - element was detached from the DOM, retrying

    at /Users/michaelmcisaac/GitHub/teaching-engine2.0/tests/e2e/holiday-planner.spec.ts:29:14
```
...
> 29 |   await page.fill('input[type="date"]', '2025-12-25');
  ...
  36 |   await page.waitForResponse((r) => r.url().includes('/calendar-events') && r.status() === 200);
